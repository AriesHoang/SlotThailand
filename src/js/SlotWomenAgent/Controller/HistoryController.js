...
(function () {
    ...
    SlotWomenAgent.HistoryController = BaseController.extend({
        ctor: function () {
            this._super.apply(this, arguments);
            SlotWomenAgent.SlotClient.getInstance().addExtensionListener("60", this.onDataReceived, this);
        ...
        sendRequestData: function (page) {
            SlotWomenAgent.SlotClient.getInstance().sendExtensionRequestCurrentRoom("60", {1: page * 10, 2: 10});
        },

        sendRequestDetail: function (session) {
            SlotWomenAgent.SlotClient.getInstance().sendExtensionRequestCurrentRoom("22", {1: session});
        },
