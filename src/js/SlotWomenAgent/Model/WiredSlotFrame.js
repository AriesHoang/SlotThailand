...
(function () {
    var SlotFrame = SlotWomenAgent.SlotFrame;
    ...
    SlotWomenAgent.WiredSlotFrame = SlotFrame.extend({
        ...
        _implementWires: function () {
            ...
            for (var i = 0; i < this.wires.length; i++) {
                var w = new cc.Sprite("res/SlotWomenAgent/payline/Payline_" + (i + 1) + ".png");
                if (i === 0)
                    w.setPosition(-20, 50);
                else if (i === 1)
            ...
            for (var i = 0; i < this.column; i++) {
                for (var j = 0; j < this.row; j++) {
                    ...
                    if (slotObj.getValue() !== symbolValue)
                        continue;
                    var eff = sp.SkeletonAnimation.createWithJsonFile("res/SlotWomenAgent/spine/effect_sym_fire.json", "res/SlotWomenAgent/spine/effect_sym_fire.atlas");
