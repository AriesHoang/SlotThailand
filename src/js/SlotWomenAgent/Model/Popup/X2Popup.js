...
(function () {
    var Popup = SlotWomenAgent.Popup;
    var X2Controller = SlotWomenAgent.X2Controller;
    SlotWomenAgent.X2Popup = Popup.extend({
        ctor: function (potentialReward,baseReward) {
            ...
            var bg = new cc.Sprite("res/SlotWomenAgent/main_background.png");
            ...
            var expectLabel = new cc.LabelBMFont(cc.GlobalSlotWomenAgent.FormatGold(potentialReward), cc.SlotWomenAgentRes.font.Bay_Buom_X2Popup);
            ...
            var totalWinLabel = new cc.LabelBMFont("0", cc.SlotWomenAgentRes.font.Bay_Buom_Stroke_White);
        ...
        showWinGame: function (amount,expected) {
            ...
            this.expectLabel.setString(cc.GlobalSlotWomenAgent.FormatGold(expected));
            this._pending = false;
        ...
        setTotalWin: function (value) {
            this.totalWinLabel.setString(cc.GlobalSlotWomenAgent.FormatGold(value));
        },
