...
(function () {
    ...
    SlotWomenAgent.HistoryDialog = Dialog.extend({
        ctor: function () {
        ...
        showResult: function (result) {
            ...
            for (var i = 0; i < result.length; i++) {
                ...
                var session = new cc.LabelBMFont("#" + entry["session"] + "", cc.SlotWomenAgentRes.font.PopupFont);
                session.setPosition(59, container.height / 2);
                container.addChild(session);

                var time = new cc.LabelBMFont(entry["time"] + "", cc.SlotWomenAgentRes.font.PopupFont);
                time.setAlignment(cc.TEXT_ALIGNMENT_CENTER);
                time.setPosition(200, session.y);
                container.addChild(time);

                var betCount = new cc.LabelBMFont(entry["betCount"] + "", cc.SlotWomenAgentRes.font.PopupFont);
                betCount.setPosition(372, session.y);
                container.addChild(betCount);

                var betLevel = new cc.LabelBMFont(cc.GlobalSlotWomenAgent.FormatGold(entry["betLevel"]) + "", cc.SlotWomenAgentRes.font.PopupFont);
                betLevel.setPosition(567, session.y);
                container.addChild(betLevel);

                var rewardLine = new cc.LabelBMFont(entry["rewardLine"] + "", cc.SlotWomenAgentRes.font.PopupFont);
                rewardLine.setPosition(753, session.y);
                container.addChild(rewardLine);

                var reward = new cc.LabelBMFont(cc.GlobalSlotWomenAgent.FormatGold(entry["reward"]), cc.SlotWomenAgentRes.font.PopupFont);
        ...
        showDetail: function (details) {
            ...
            for (var i = 0; i < details.length; i++) {
                ...
                var betLine = new cc.LabelBMFont(entry["line"] + "", cc.SlotWomenAgentRes.font.PopupFont);
