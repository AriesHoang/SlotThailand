...
(function () {
    ...
    var RankingController = SlotWomenAgent.RankingController;
    SlotWomenAgent.RankingDialog = HistoryDialog.extend({
        ctor: function () {
            var width = 1178;
            var height = 658;
        ...
        initResultItem: function (result) {
            ...
            for (var i = 0; i < result.length; i++) {
                ...
                var account = new cc.LabelBMFont(entry.username, cc.SlotWomenAgentRes.font.PopupFont);
                account.setPosition(309, time.y);
                container.addChild(account);

                var room = new cc.LabelBMFont(cc.GlobalSlotWomenAgent.FormatGold(entry.betLevel), cc.SlotWomenAgentRes.font.PopupFont);
                room.setPosition(492, time.y);
                container.addChild(room);

                var reward = new cc.LabelBMFont(cc.GlobalSlotWomenAgent.FormatGold(entry.totalReward), cc.SlotWomenAgentRes.font.PopupFont);
                ...
                var description = new cc.LabelBMFont(str, cc.SlotWomenAgentRes.font.PopupFont);
