...
(function () {
    ...
    SlotWomenAgent.CompleteBonusDialog = Dialog.extend({
        ctor: function (reward, multiplier, exitCallback, width, height) {
            ...
            var rewardPanel = new cc.Sprite("#slotwomenagent_bonus_complete_panel.png");
            rewardPanel.setPosition(this.width / 2, this.height / 2 + 50);
            this.addChild(rewardPanel);

            var totalBonusLabel = new cc.LabelBMFont("0", cc.SlotWomenAgentRes.font.Bonus_Result);
            ...
            totalBonusLabel.setString(cc.GlobalSlotWomenAgent.FormatGold(baseReward) + " X" + multiplier + " \n\t= " + cc.GlobalSlotWomenAgent.FormatGold(reward));
