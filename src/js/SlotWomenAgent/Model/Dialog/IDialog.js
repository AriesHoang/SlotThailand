...
(function () {
    SlotWomenAgent.Dialog = cc.Node.extend({
        ...
        _initWithSize: function (size, y) {
            ...
            // title
            // var title = new cc.LabelBMFont("", cc.SlotWomenAgentRes.font.Bay_Buom_Text_Stroke);
            var title = new cc.LabelTTF("", cc.SlotWomenAgentRes.font.UVNThangVu, 50, cc.p(400, 300), cc.TEXT_ALIGNMENT_CENTER, cc.VERTICAL_TEXT_ALIGNMENT_CENTER);
        ...
        initBackground: function (w, h) {
            // background
            var dialogBg = new cc.Sprite("res/SlotWomenAgent/slotwomenagent_bg_popup.png");
