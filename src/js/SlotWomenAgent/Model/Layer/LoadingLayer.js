...
(function () {
    SlotWomenAgent.LoadingLayer = cc.Node.extend({
        ctor: function (title, content) {
            ...
            var agreeLabel = new cc.LabelBMFont("OK", cc.SlotWomenAgentRes.font.PopupFont);
        ...
        initLabels: function (title, content) {
            // cc.log("titleLabel");
            var titleLabel = new cc.LabelBMFont(title, cc.SlotWomenAgentRes.font.PopupFont);
            titleLabel.setScale(1.2);
            titleLabel.setPosition(20, 150);
            this.addChild(titleLabel);

            // cc.log("contentLabel");
            var contentLabel = new cc.LabelBMFont(content, cc.SlotWomenAgentRes.font.PopupFont);
