...
(function () {
    var SlotObject = SlotWomenAgent.SlotObject;
    var AllSlotObject = SlotWomenAgent.AllSlotObject;
    SlotWomenAgent.SlotFrame = cc.Node.extend({
        ...
        _initSlotFrame: function () {
            ...
            // var slotBackground = new cc.Sprite("res/SlotWomenAgent/slotmhv_frame_bg.png");
            var slotFrame = new cc.Sprite("res/SlotWomenAgent/slotwomenagent_frame.png");
            ...
            for (var i = 0; i < row * column; i++) {
                var slotObj = new SlotObject(cc.GlobalSlotWomenAgent.randomInt(0, 10));
            ...
            for (var i = 0; i < (row + 2) * column; i++) {
                var rollingSlotObj = new cc.Sprite("#slotwomenagent_Sym_" + AllSlotObject[cc.GlobalSlotWomenAgent.randomInt(0, 10)] + ".png");
