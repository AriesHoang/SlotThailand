...
(function () {
    var res = SlotWomenAgent.res;
    var res_initial = SlotWomenAgent.res_initial;
    var res_texture = SlotWomenAgent.res_texture;

    SlotWomenAgent.LoadingScene = cc.Scene.extend({
        ctor: function () {
            this._super();
            ...
            var loadingLabel = new cc.Sprite("res/SlotWomenAgent/loading.png");
        ...
        loadResources: function (index) {
            ...
            cc.loader.load(res[index], function (err, result) {
                ...
                if (index < res.length) {
                    ...
                    SlotWomenAgent.SlotClient.getInstance().connect();
                }
            });
        },

        onReconnect: function () {
            // var scene = new SlotWomenAgent.SlotScene();
