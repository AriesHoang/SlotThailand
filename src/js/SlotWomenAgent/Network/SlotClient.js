...
(function () {
    SlotWomenAgent.SlotClient = (function () {
        var instance = null;
        var CONNECTING = 0;
        var OPEN = 1;
        var CLOSING = 2;
        ...
        var Clazz = cc.Class.extend({
            ...
            checkAndReconnect: function () {
                ...
                do {
                    ...
                    this._connectTimeout = setTimeout(function () {
                        ...
                        if (scene) {
                            var l = new SlotWomenAgent.LoadingLayer("NOTIFICATION", "Unable to connect to the server.\nThe system will reconnect in a moment.");
            ...
            getToken: function () {
                if (cc.GlobalSlotWomenAgent.AccessToken)
                    return cc.GlobalSlotWomenAgent.AccessToken;
            ...
            _onJoinRoomListener: function (msgType, data) {
                SlotWomenAgent.SFS.roomId = data["p"]["1"];
                var scene = cc.director.getRunningScene();
            ...
            sendExtensionRequestCurrentRoom: function (command, params) {
                if (SlotWomenAgent.SFS.roomId < 0)
                    return;
                this.sendExtensionRequest(SlotWomenAgent.SFS.roomId, command, params);
            }
        });
