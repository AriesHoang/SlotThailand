var SlotWomenAgentFloatButton = (function () {
    var instance = null;

    var SlotWomenAgentExpandedFloatBtn = cc.Node.extend({
        ctor: function () {
            this._super();
        ...
        initMinigameList: function () {
            var listMinigame = cc.GlobalSlotWomenAgent.miniGameData;
    ...
    var SlotWomenAgentFloatButtonClass = cc.Node.extend({
        ctor: function () {
            if (instance) {
        ...
        expand: function () {
            this.expanded = true;
            this.visible = false;
            var expandedNode = new SlotWomenAgentExpandedFloatBtn();
    ...
    SlotWomenAgentFloatButtonClass.getInstance = function () {
        if (!instance) {
            instance = new SlotWomenAgentFloatButtonClass();
            instance.retain();
        }
        return instance;
    };

    return SlotWomenAgentFloatButtonClass;
