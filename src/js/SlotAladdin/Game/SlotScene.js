...
(function () {
    var BaseScene = SlotAladdin.BaseScene;
    var SlotController = SlotAladdin.SlotController;
    var WiredSlotFrame = SlotAladdin.WiredSlotFrame;
    var SettingItem = SlotAladdin.SettingItem;
    var FreeSpinNode = SlotAladdin.FreeSpinNode;
    var GoldenTime = SlotAladdin.GoldenTime;
    var MainButton = SlotAladdin.MainButton;
    var HistoryDialog = SlotAladdin.HistoryDialog;
    var RankingDialog = SlotAladdin.RankingDialog;
    var RewardDialog = SlotAladdin.RewardDialog;
    var CompleteFreeSpinDialog = SlotAladdin.CompleteFreeSpinDialog;
    var X2Popup = SlotAladdin.X2Popup;
    ...
    var SlotScene = BaseScene.extend({
        ctor: function (row, column) {
            ...
            SlotAladdinSoundPlayer.playSound("theme_hauvuong", true);

            var slotFrame = new WiredSlotFrame(row, column);
            SlotAladdin.Lines && slotFrame.setWires(SlotAladdin.Lines);
            this.slotFrame = slotFrame;
            slotFrame.setPosition(cc.winSize.width / 2, cc.winSize.height / 2 - 40);
            this.gameLayer.addChild(slotFrame);
            if (cc.GlobalSlotAladdin.lastResult)
                slotFrame.setResult(cc.GlobalSlotAladdin.lastResult);

            // var btmBar = new ccui.Scale9Sprite("SlotAladdin_slot_btm_bar.png", cc.rect(0, 0, 1, 1));
            ...
            // var logo = new cc.Sprite("res/SlotAladdin/SlotAladdin_logo_game.png");
            ...
            this.setSelectedLines(cc.GlobalSlotAladdin.SlotState.lines || defaultLines);
            this.setFreeSpinCount(0);
            thiz.setBetLevel(cc.GlobalSlotAladdin.SlotState.betLevel || 0, cc.GlobalSlotAladdin.isSandboxMode || isNaN(cc.GlobalSlotAladdin.SlotState.betLevel) === false);
            this.setTotalWin(cc.GlobalSlotAladdin.totalRewardValue || 0, true, true, true);
            this.setCredit(cc.GlobalSlotAladdin.PlayerGold);
            this.setState(SlotState.IDLE);

            // this.initCheatLayer();

            this._performPendingFSAction();
            this.setSession(cc.GlobalSlotAladdin.sessionId);

            if (cc.GlobalSlotAladdin.FreeSpinCount)
                this.setFreeSpinCount(cc.GlobalSlotAladdin.FreeSpinCount);
            if (cc.GlobalSlotAladdin.PortalFreeSpinCount)
                this.setPortalFreeSpinCount(cc.GlobalSlotAladdin.PortalFreeSpinCount);
            else if (cc.GlobalSlotAladdin.FreeSpinGame.enabled && cc.GlobalSlotAladdin.FreeSpinCount === 0)
                this.showCompleteFreeSpinDialog();

            if (cc.GlobalSlotAladdin.AutoSpin)
                this.toggleAutoSpin();

            if (cc.GlobalSlotAladdin.FastRoll)
                this.toggleFastRoll();

            if (cc.GlobalSlotAladdin.isSandboxMode) {
                this.switchToSandbox(cc.GlobalSlotAladdin.PlayerGold);
                this._setJackPotLabel(cc.GlobalSlotAladdin.sandboxJackpot);
            }
            ...
            //ShowMinigame Butotn
            SlotAladdinFloatButton.getInstance().show(this);
            //Hide all Minigame
        ...
        testShowLine: function () {
            ...
            // for (var i = 1; i < 2; i++) {
            // var wireNode = new cc.Sprite("res/SlotAladdin/payline/Payline_1.png");
        ...
        initGUI: function () {
            var jackpotLabel = new cc.LabelBMFont("500,000", cc.SlotAladdinRes.font.JackpotFont);
            ...
            var settingPanel = new ccui.Scale9Sprite("slotaladdin_setting_panel.png");
            ...
            var soundSetting = new SettingItem("slotaladdin_setting_sound.png", 1);
            soundSetting.setPosition(44, 90);
            settingPanel.addChild(soundSetting);

            var musicSetting = new SettingItem("slotaladdin_setting_music.png", 2);
            ...
            var sessionBg = new cc.Sprite("#slotaladdin_bg_credit.png");
            sessionBg.setPosition(cc.winSize.width - 410, cc.winSize.height - 70);
            sessionBg.setScale(1.0);
            this.gameLayer.addChild(sessionBg);

            var sessionLabel = new cc.LabelBMFont("# 123", cc.SlotAladdinRes.font.CreditFont);
            sessionLabel.setPosition(sessionBg.x + 10, sessionBg.y + 5);
            this.gameLayer.addChild(sessionLabel, 1);
            this.sessionLabel = sessionLabel;

            var thiz = this;
            var btnDong = new ccui.Button("slotaladdin_line.png", "slotaladdin_line.png", "", ccui.Widget.PLIST_TEXTURE);
            ...
            var btnCuoc = new ccui.Button("slotaladdin_bet.png", "slotaladdin_bet.png", "", ccui.Widget.PLIST_TEXTURE);
            ...
            // var cuocLabel = new cc.LabelTTF(MultiLanguage.getTextByKey("BET_TITLE"), cc.SlotAladdinRes.font.UVNThangVu, 38, cc.p(200, 200), cc.TEXT_ALIGNMENT_CENTER, cc.VERTICAL_TEXT_ALIGNMENT_CENTER);
            ...
            var sandboxSprite = new cc.Sprite("#slotaladdin_sandbox_btn.png");
            ...
            // var sandboxText1 = new cc.LabelTTF("TRAIL PLAY", cc.SlotAladdinRes.font.UVNThangVu, 35);
            ...
            var portalFreeSpin = new cc.Sprite("#slotaladdin_free_spin.png");
            ...
            var portalFSCount = new cc.LabelBMFont("0", cc.SlotAladdinRes.font.FreeSpinFont);
            // var portalFSCount = new cc.LabelTTF("0", "Arial", 40);
            portalFSCount.setPosition(105, 110);
            portalFreeSpin.addChild(portalFSCount);

            // var portalFS = new cc.LabelTTF(MultiLanguage.getTextByKey("FREE_SPIN_TITLE"), cc.SlotAladdinRes.font.UVNThangVu, 35);
        ...
        initButton: function () {
            var homeBtn = new ccui.Button("slotaladdin_home_btn.png", "slotaladdin_home_btn.png", "", ccui.Widget.PLIST_TEXTURE);
            homeBtn.setPosition(93, cc.winSize.height - 70);
            this.gameLayer.addChild(homeBtn);

            var sandboxBtn = new ccui.Button("slotaladdin_sandbox_btn.png", "", "", ccui.Widget.PLIST_TEXTURE);
            sandboxBtn.setPosition(480, cc.winSize.height - 150);
            sandboxBtn.setZoomScale(0);
            this.sandboxBtn = sandboxBtn;
            this.gameLayer.addChild(sandboxBtn);

            // var sandboxText = new cc.LabelTTF("TRAIL PLAY", cc.SlotAladdinRes.font.UVNThangVu, 35);
            ...
            var casualBtn = new ccui.Button("slotaladdin_icon_casualmark.png", "", "", ccui.Widget.PLIST_TEXTURE);
            casualBtn.setPosition(80, 75);
            this.gameLayer.addChild(casualBtn);

            var autoRollBtn = new ccui.Button("slotaladdin_auto_roll_btn.png", "", "", ccui.Widget.PLIST_TEXTURE);
            autoRollBtn.setZoomScale(0);
            autoRollBtn.setPosition(1500, 80);
            this.gameLayer.addChild(autoRollBtn);
            this.autoRollBtn = autoRollBtn;

            // var autoRollLabel = new cc.LabelBMFont("QUAY\n\nTỰ ĐỘNG", cc.SlotAladdinRes.font.Bay_Buom_Text_Stroke);
            // var autoRollLabel = new cc.LabelTTF("QUAY\nTỰ ĐỘNG", cc.SlotAladdinRes.font.UVNThangVu, 38);
            // var autoRollLabel = new cc.LabelTTF(MultiLanguage.getTextByKey("AUTO_ROLL_TITLE"), cc.SlotAladdinRes.font.UVNThangVu, 38);
            ...
            var rollSprite = new cc.Sprite("#slotaladdin_roll_btn.png");
            ...
            // var rollBtn = new ccui.Button("slotaladdin_roll_btn.png", "", "", ccui.Widget.PLIST_TEXTURE);
            // rollBtn.setZoomScale(0);
            // rollBtn.setPosition(cc.winSize.width - 200, rollBtn.height / 2);
            // this.gameLayer.addChild(rollBtn);

            // var rollSpine = sp.SkeletonAnimation.createWithJsonFile("res/SlotAladdin/spine/effect_spin.json", "res/SlotAladdin/spine/effect_spin.atlas");
            ...
            // var rollSprite = new cc.Sprite("res/SlotAladdin/slotaladdin_btn_roll.png");
            // rollSprite.setPosition(cc.winSize.width - 200, rollSprite.height / 2 + 20);
            // this.gameLayer.addChild(rollSprite);

            var infoBtn = new ccui.Button("slotaladdin_icon_info.png", "", "", ccui.Widget.PLIST_TEXTURE);
            infoBtn.setPosition(cc.winSize.width - 550, cc.winSize.height - 160);
            this.gameLayer.addChild(infoBtn);

            var rankingBtn = new ccui.Button("slotaladdin_icon_ranking.png", "", "", ccui.Widget.PLIST_TEXTURE);
            rankingBtn.setPosition(infoBtn.x + 130, infoBtn.y);
            this.gameLayer.addChild(rankingBtn);

            var settingBtn = new ccui.Button("slotaladdin_icon_setting.png", "", "", ccui.Widget.PLIST_TEXTURE);
            ...
            // var x2Sprite = new cc.Sprite("#slotaladdin_x2_btn.png");
            ...
            homeBtn.addClickEventListener(function () {
                ...
                if (!thiz.musicSetting.getDisabled())
                    SlotAladdinSoundPlayer.playSound("spin_button_press", false);
                // cc.log("GOTOHOME-------------");
                SlotAladdin.SlotClient.getInstance().closeSocket();
                //Hide all Minigame
                MiniGameNavigator.hideAll();
                SlotAladdinSoundPlayer.stopSound("theme_hauvuong");
                SlotAladdinSoundPlayer.stopSound("spin");
                thiz.autoSpin = false;
        ...
        initCharacter: function () {
            // var wukong = sp.SkeletonAnimation.createWithJsonFile("res/SlotAladdin/spine/wukong.json", "res/SlotAladdin/spine/wukong.atlas");
            // wukong.setPosition(230, cc.winSize.height / 2 - 350);
            // wukong.setScale(1);
            // wukong.setAnimation(0, "animation", true);

            var pillow = new cc.Sprite("res/SlotAladdin/pillow.png");
            pillow.setPosition(150, 150);
            this.gameLayer.addChild(pillow);

            var buc = new cc.Sprite("res/SlotAladdin/buc.png");
            buc.setPosition(cc.winSize.width/2, 98);
            // wukong.setScale(1);
            this.gameLayer.addChild(buc);

            var agent = new cc.Sprite("res/SlotAladdin/agent.png");
            agent.setPosition(150, cc.winSize.height / 2 + 50);
            // wukong.setScale(1);
            this.gameLayer.addChild(agent);


            var lamp = new cc.Sprite("res/SlotAladdin/lamp.png");
            lamp.setPosition(100, 340);
            this.gameLayer.addChild(lamp);

            // var peach = sp.SkeletonAnimation.createWithJsonFile("res/SlotAladdin/spine/effect_peach.json", "res/SlotAladdin/spine/effect_peach.atlas");
        ...
        toggleAutoSpin: function () {
            ...
            this.autoRollBtn.loadTextureNormal(this.autoSpin ? "slotaladdin_auto_roll_btn.png" : "slotaladdin_auto_roll_btn_inactive.png",
                ccui.Widget.PLIST_TEXTURE);
            if (this.autoSpin && this.state === SlotState.IDLE)
                this.onQuayBtnClick();

            cc.GlobalSlotAladdin.AutoSpin = this.autoSpin;
        },
        ...
        toggleFastRoll: function () {
            ...
            cc.GlobalSlotAladdin.FastRoll = this.fastRoll;
        },
        ...
        setCredit: function (value) {
            ...
            this._pendingCredit = function () {
                ...
                SlotAladdin.runActionNumber(thiz.creditLabel, cc.GlobalSlotAladdin.PlayerGold, thiz._oldCreditValue);
                thiz._oldCreditValue = cc.GlobalSlotAladdin.PlayerGold;

                thiz._pendingCredit = null;
            };

            if (bet < 0) {
                cc.GlobalSlotAladdin.PlayerGold = money;
                this._pendingCredit();
            } else if (bet === 0) {
                cc.GlobalSlotAladdin.PlayerGold = money;
                this._pendingCredit();
        ...
        setSelectedLines: function (selectedLines) {
            ...
            if (selectedLines instanceof Array && selectedLines.length > 0) {
                ...
                this.totalBetLabel.setString(cc.GlobalSlotAladdin.FormatGold(
                    this.allBetLevel[this.betLevel] * this.selectedLines.length));

                cc.GlobalSlotAladdin.SlotState.lines = this.selectedLines;
            }
        ...
        onQuayBtnClick: function (cheatType) {
            ...
            if (this.portalFreeSpinCount) {
                ...
                cc.GlobalSlotAladdin.FreeSpinGame.enabled = true;
                cc.GlobalSlotAladdin.FreeSpinGame.count++;
            ...
            if (!this.musicSetting.getDisabled())
                SlotAladdinSoundPlayer.playSound("spin", false);
            ...
            fn(this.betLevel, this.selectedLines, (this.cheatTF) ? this.cheatTF.getString() : null,
                cc.GlobalSlotAladdin.FreeSpinGame.enabled || this.autoSpin);
            // fn(this.betLevel, this.selectedLines, null, cc.GlobalSlotAladdin.FreeSpinGame.enabled || this.autoSpin);
        ...
        showX2Game: function () {
            ...
            var node = new X2Popup(cc.GlobalSlotAladdin.pendingX2Value, cc.GlobalSlotAladdin.pendingX2Base);
            ...
            node.setExitCallback(function (winAmount) {
                ...
                this.setState(SlotState.IDLE);
                cc.GlobalSlotAladdin.totalRewardValue += winAmount;
                this.setTotalWin(cc.GlobalSlotAladdin.totalRewardValue, true, null, true);
                this.x2Btn.visible = false;
            }, this);
        },
        ...
        updateSlotResult: function (result) {
            if (this._isWaitingResult) {
                ...
                cc.GlobalSlotAladdin.pendingX2 = result["x2"];
            }
        },
        ...
        rewardCallback: function (totalResult, result) {
            ...
            var showBonusAction = new cc.CallFunc(function () {
                ...
                if (!thiz.musicSetting.getDisabled())
                    SlotAladdinSoundPlayer.playSound("bonus", false);
                thiz.hideAllDialog();
                effectLayer.visible = true;
                // tnkEffect.visible = false;
                var effect_win_bonus = sp.SkeletonAnimation.createWithJsonFile('res/SlotAladdin/spine/win_bonus.json', 'res/SlotAladdin/spine/win_bonus.atlas');
            ...
            var showFreeSpinAction = new cc.CallFunc(function () {
                ...
                if (!thiz.musicSetting.getDisabled())
                    SlotAladdinSoundPlayer.playSound("freespin_xuathien", false);
                ...
                effectLayer.visible = true;
                // tnkEffect.visible = false;
                // var effect_win_freespin = sp.SkeletonAnimation.createWithJsonFile('res/SlotAladdin/spine/win_freespin.json', 'res/SlotAladdin/spine/win_freespin.atlas');
                ...
                var effect_win_freespin = new cc.Sprite("res/SlotAladdin/Win/slotaladdin_freespin.png");
                effect_win_freespin.setPosition(cc.winSize.width / 2, cc.winSize.height / 2);
                effectLayer.addChild(effect_win_freespin);

                // var label = new cc.LabelBMFont("+" + totalResult["free_spin_count"] + " LƯỢT QUAY", cc.SlotAladdinRes.font.Dialog_Title);
            ...
            var afterAction = new cc.CallFunc(function () {
                var chainSequence = function () {
                    ...
                    if (totalResult["free_spin"] && totalResult["bonus"]) {
                        ...
                        showFreeSpinAction.release();
                        finishAction.release();
                        cc.GlobalSlotAladdin.pendingFSReward = totalResult["free_spin"];
        ...
        onRollResult: function (result) {
            ...
            cc.GlobalSlotAladdin.lastResult = result["1"];
            for (var i = 0; i < this.slotFrame.column; i++) {
                setTimeout(function (index) {
            ...
            setTimeout(function () {
                ...
                var chainSequence = function () {
                    ...
                    var showLineReward = cc.callFunc(function () {
                        ...
                        slotFrame.showReward(thiz.fastRoll, result["2"], result["free_spin"], result["bonus"], function (shownLine) {
                            if (shownLine.type === 2) {
                                if (!thiz.musicSetting.getDisabled())
                                    SlotAladdinSoundPlayer.playSound("win_small", false);
                    ...
                    //     + "\n ------ Global freeSpinCount------: " + cc.GlobalSlotAladdin.FreeSpinGame.count);
                    ...
                    if (!result["free_spin"]
                        ...
                        && (cc.GlobalSlotAladdin.FreeSpinGame.count === 0 || cc.GlobalSlotAladdin.FreeSpinGame.count === undefined)) {
                ...
                var showBigWinAction = new cc.CallFunc(function () {
                    ...
                    if ([2, 3, 4, 5].indexOf(winType) !== -1) {
                        // var label = new cc.LabelBMFont("", cc.SlotAladdinRes.font.Total_Reward_Font);
                        ...
                        SlotAladdin.runActionNumber(label, rewardValue);
                        effectLayer.addChild(label);
                        // effect.setScale(0.8);
                    }
                    ...
                    switch (winType) {
                        case 2:
                            // cc.log("case2");
                            if (!thiz.musicSetting.getDisabled())
                                SlotAladdinSoundPlayer.playSound("win_medium", false);
                            effectLayer.visible = true;
                            // var effect_win_rich = sp.SkeletonAnimation.createWithJsonFile('res/SlotAladdin/spine/win_rich.json', 'res/SlotAladdin/spine/win_rich.atlas');
                            ...
                            //     chainSequence();
                            // });
                            var effect_win_rich = new cc.Sprite("res/SlotAladdin/Win/slotaladdin_epicwin.png");
                        ...
                        case 4:
                            // cc.log("case34");
                            if (!thiz.musicSetting.getDisabled())
                                SlotAladdinSoundPlayer.playSound("win_large", false);
                            effectLayer.visible = true;
                            // var effect_win_big = sp.SkeletonAnimation.createWithJsonFile('res/SlotAladdin/spine/win_big.json', 'res/SlotAladdin/spine/win_big.atlas');
                            ...
                            //     chainSequence();
                            // });
                            var effect_win_big = new cc.Sprite("res/SlotAladdin/Win/slotaladdin_bigwin.png");
                        ...
                        case 5:
                            ...
                            effectLayer.visible = true;
                            if (!thiz.musicSetting.getDisabled())
                                SlotAladdinSoundPlayer.playSound("jackpot_xuathien", false);
                            // thiz.totalRewardLabel.setString(cc.GlobalSlotAladdin.FormatGold(rewardValue));
                            // var effect_win_jackpot = sp.SkeletonAnimation.createWithJsonFile('res/SlotAladdin/spine/win_jackpot.json', 'res/SlotAladdin/spine/win_jackpot.atlas');
                            ...
                            //     // effect_win_big.setScale(1);
                            //     if (!thiz.musicSetting.getDisabled())
                            //         SlotAladdinSoundPlayer.playSound("jackpot_ketthuc", false);
                            //     chainSequence();
                            // });
                            var effect_win_jackpot = new cc.Sprite("res/SlotAladdin/Win/slotaladdin_jackpotwin.png");
        ...
        setBetLevel: function (betId, noRequest) {
            ...
            if (~[0, 1, 2].indexOf(betId)) {
                this.betLevel = betId;
                this.betLevelLabel.setString(cc.GlobalSlotAladdin.FormatGold(this.allBetLevel[betId]));
                this.totalBetLabel.setString(cc.GlobalSlotAladdin.FormatGold(this.allBetLevel[betId] * this.selectedLines.length));
                this._setJackPotLabel(this.jackpotValues[this.betLevel]);

                if (!noRequest)
                    this._controller.sendSetBetLevelRequest(betId);

                cc.GlobalSlotAladdin.SlotState.betLevel = this.betLevel;
        ...
        updateBetAmount: function (allBetLevel) {
            ...
            this.betLevelLabel.setString(cc.GlobalSlotAladdin.FormatGold(this.allBetLevel[this.betLevel]));
            this.totalBetLabel.setString(cc.GlobalSlotAladdin.FormatGold(this.allBetLevel[this.betLevel] * this.selectedLines.length));
        },
        ...
        _setJackPotLabel: function (value) {
            ...
            SlotAladdin.runActionNumber(this.jackpotLabel, value, this._oldJackpotValue);
            this._oldJackpotValue = value;

            if (this.isSandboxMode)
                cc.GlobalSlotAladdin.sandboxJackpot = value;
        },
        ...
        setPendingPortalFreeSpinCount: function (count) {
            var thiz = this;
            cc.GlobalSlotAladdin.PortalFreeSpinCount = count;
        ...
        setPendingFreeSpinCount: function (count) {
            var thiz = this;
            cc.GlobalSlotAladdin.FreeSpinCount = count;
        ...
        configLine: function (lines) {
            SlotAladdin.Lines && this.slotFrame.setWires(lines);
        },
        ...
        setTotalWin: function (value, hideEffect, jackpotValue, isRaw, skipFSReward) {
            ...
            cc.GlobalSlotAladdin.totalRewardValue = value + jackpotValue;
            if (value === 0) {
                this.totalRewardLabel.setString(cc.GlobalSlotAladdin.FormatGold(value));
            } else if (value > 0) {

                // free spin game
                if (!skipFSReward && cc.GlobalSlotAladdin.FreeSpinGame.enabled)
                    cc.GlobalSlotAladdin.FreeSpinGame.reward += value;

                if (hideEffect) {
                    // this.totalRewardLabel.setString(cc.GlobalSlotAladdin.FormatGold(value + jackpotValue));
                } else {
                    // var bg = new ccui.Scale9Sprite("SlotAladdin_total_reward_bg.png", cc.rect(160, 10, 2, 2));
                    // var bg = new cc.Sprite("#SlotAladdin_total_reward_bg.png");
                    // // bg.setPreferredSize(cc.size(828, 193));
                    // bg.setPosition(993, cc.winSize.height / 2);
                    // this.gameLayer.addChild(bg, 430);

                    var totalLabel = new cc.LabelBMFont(cc.GlobalSlotAladdin.FormatGold(value + jackpotValue), jackpotValue > 0 ? cc.SlotAladdinRes.font.RewardJackpotFont : cc.SlotAladdinRes.font.RewardNormalFont);
                    totalLabel.setPosition(1030, cc.winSize.height / 2);
                    this.gameLayer.addChild(totalLabel, 431);

                    // var decorator = new cc.Sprite("#SlotAladdin_total_reward_decorator.png");
                    ...
                    var callFunc = new cc.CallFunc(function () {
                        ...
                        thiz.totalRewardLabel.setString(cc.GlobalSlotAladdin.FormatGold(value + jackpotValue));
                    });
        ...
        switchToSandbox: function (coin) {
            ...
            this.sandboxBtn.loadTextureNormal("slotaladdin_sandbox_off_btn.png", ccui.Widget.PLIST_TEXTURE);
            ...
            cc.GlobalSlotAladdin.isSandboxMode = true;
            this.setCredit(coin);
        },
        ...
        quitSandbox: function () {
            ...
            this.sandboxBtn.loadTextureNormal("slotaladdin_sandbox_btn.png", ccui.Widget.PLIST_TEXTURE);
            // this.sandboxText.setString("TRAIL PLAY");
            // this.sandboxText.setPosition(this.sandboxBtn.width / 2, this.sandboxBtn.height / 2);
            this.sandboxSprite.visible = false;
            cc.GlobalSlotAladdin.isSandboxMode = false;
            cc.GlobalSlotAladdin.sandboxJackpot = undefined
        },

        setSession: function (sessionId) {
            this.sessionLabel.setString(sessionId ? ("#" + sessionId) : "");
            cc.GlobalSlotAladdin.sessionId = sessionId;
        },
        ...
        toggleLinesSelect: function () {
            ...
            if (this.selectedLines.length < SlotAladdin.Lines.length) {
        ...
        setState: function (state) {
            ...
            if (state === SlotState.IDLE) {
                ...
                if (cc.GlobalSlotAladdin.pendingX2) {
                    this.setState(SlotState.SHOWING_X2);
                    cc.GlobalSlotAladdin.pendingX2 = undefined;
                    setTimeout(function () {
                        // thiz.showX2Game();
                    }, 2000);
                    return;
        ...
        showCompleteFreeSpinDialog: function () {
            ...
            cc.log(cc.GlobalSlotAladdin.FreeSpinGame.count, cc.GlobalSlotAladdin.FreeSpinGame.reward);
            // var d = new CompleteFreeSpinDialog(cc.GlobalSlotAladdin.FreeSpinGame.count, cc.GlobalSlotAladdin.FreeSpinGame.reward);
        ...
        setPotentialDoubleAmount: function (amount, baseAmount) {
            cc.GlobalSlotAladdin.pendingX2Base = baseAmount;
            cc.GlobalSlotAladdin.pendingX2Value = amount;
        },

        showBonusGame: function () {
            // cc.log("SHOW BONUS GAME");
            cc.director.replaceScene(new SlotAladdin.BonusScene(this.betLevel, this.isSandboxMode));
            SlotAladdinSoundPlayer.stopSound("theme_hauvuong");
        },

        _performPendingFSAction: function () {
            if (!cc.GlobalSlotAladdin.pendingFSReward)
                return;
            ...
            // background effect
            // var effect = sp.SkeletonAnimation.createWithJsonFile('res/SlotAladdin/spine/tnk_win.json', 'res/SlotAladdin/spine/tnk_win.atlas');
            ...
            var effect = sp.SkeletonAnimation.createWithJsonFile('res/SlotAladdin/spine/win_freespin.json', 'res/SlotAladdin/spine/win_freespin.atlas');
            ...
            var label = new cc.LabelBMFont("+" + cc.GlobalSlotAladdin.pendingFSReward + " SPIN", cc.SlotAladdinRes.font.Room_Name);
            label.setScale(2);
            label.setPosition(cc.winSize.width / 2, cc.winSize.height / 2 - 350);
            effectLayer.addChild(label);
            effect.setCompleteListener(function () {
            ...
            cc.GlobalSlotAladdin.pendingFSReward = undefined;
        },
        ...
        onReconnect: function () {
            ...
            this.stopRolling();
            this.setBetLevel(cc.GlobalSlotAladdin.SlotState.betLevel || 0);
        },
        ...
        updateUserChangeMoney: function (eventName, money) {
            if (this.creditLabel) {
                ...
                SlotAladdin.runActionNumber(this.creditLabel, money, cc.GlobalSlotAladdin.PlayerGold);
                cc.GlobalSlotAladdin.PlayerGold = money;
            }
        }
    });

    SlotAladdin.SlotState = SlotState;
    SlotAladdin.SlotScene = SlotScene;
})();
