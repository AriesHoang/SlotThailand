...
(function () {
    ...
    var BonusController = SlotAladdin.BonusController;
    var BonusObject = SlotAladdin.BonusObject;
    var BonusDialog = SlotAladdin.BonusDialog;
    var CompleteBonusDialog = SlotAladdin.CompleteBonusDialog;
    var BonusPrepareDialog = SlotAladdin.BonusPrepareDialog;
    var Dialog = SlotAladdin.Dialog;

    SlotAladdin.BonusScene = BaseScene.extend({
        ...
        initRewards: function () {
            ...
            var rewardPanel = new cc.Sprite("#slotaladdin_bonus_rewardPanel.png");
            rewardPanel.setPosition(cc.winSize.width - 268, cc.winSize.height - 135);
            this.mainLayer.addChild(rewardPanel);

            // var totalBonusTitle = new cc.LabelTTF("TỔNG THẮNG", cc.SlotAladdinRes.font.UVNThangVu, 40);
            // var totalBonusTitle = new cc.LabelBMFont("TỔNG THẮNG", cc.SlotAladdinRes.font.Bay_Buom_Text_Stroke);
            ...
            var totalBonusLabel = new cc.LabelBMFont("0", cc.SlotAladdinRes.font.Bonus_Reward);
            ...
            var bottomTip = new cc.Sprite("#slotaladdin_genie_title.png");
        ...
        pushFlyingText: function (str, from, to, callback) {
            var flyingLabel = new cc.LabelBMFont(str, cc.SlotAladdinRes.font.Bonus_Multiplier);
        ...
        setBonusAmount: function (value) {
            ...
            this.totalBonusLabel.setString(cc.GlobalSlotAladdin.FormatGold(this._bonusAmount));
        },
        ...
        showCompleteLayer: function () {
            ...
            this.showDialog(new CompleteBonusDialog(this._totalBonus, this._dedicatedMultiplier, function () {
                ...
                cc.GlobalSlotAladdin.totalRewardValue += value;

                // free spin game
                if (cc.GlobalSlotAladdin.FreeSpinGame.enabled)
                    cc.GlobalSlotAladdin.FreeSpinGame.reward += value;

                cc.director.replaceScene(new SlotAladdin.SlotScene());
                if (thiz.cooldown >= 0) {
