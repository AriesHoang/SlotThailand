...
(function () {
    ...
    SlotAladdin.CompleteBonusDialog = Dialog.extend({
        ctor: function (reward, multiplier, exitCallback, width, height) {
            ...
            var rewardPanel = new cc.Sprite("#slotaladdin_bonus_complete_panel.png");
            rewardPanel.setPosition(this.width / 2, this.height / 2 + 50);
            this.addChild(rewardPanel);

            var totalBonusLabel = new cc.LabelBMFont("0", cc.SlotAladdinRes.font.Bonus_Result);
            ...
            totalBonusLabel.setString(cc.GlobalSlotAladdin.FormatGold(baseReward) + " X" + multiplier + " \n\t= " + cc.GlobalSlotAladdin.FormatGold(reward));
