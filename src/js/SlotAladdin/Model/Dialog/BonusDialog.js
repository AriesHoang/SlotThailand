...
(function () {
    ...
    SlotAladdin.BonusDialog = Dialog.extend({
        ctor: function (width, height) {
            ...
            var poses = [
                {x: 578, y: cc.winSize.height / 2},
                {x: 1024, y: cc.winSize.height / 2},
                {x: 1447, y: cc.winSize.height / 2}
            ];
            ...
            var gun1 = new cc.Sprite("#slotaladdin_genie2.png");
            var gun1bg = new cc.Sprite("#slotaladdin_genie2.png");
            ...
            var gun2 = new cc.Sprite("#slotaladdin_genie1.png");
            var gun2bg = new cc.Sprite("#slotaladdin_genie1.png");
            ...
            var gun3 = new cc.Sprite("#slotaladdin_genie3.png");
            var gun3bg = new cc.Sprite("#slotaladdin_genie3.png");
            ...
            var bottomTip = new cc.Sprite("#slotaladdin_pickitem_title.png");
            bottomTip.setPosition(1012, cc.winSize.height - 150);
        ...
        revealBonus: function () {
            ...
            var label = new cc.LabelBMFont("X" + value, cc.SlotAladdinRes.font.Bonus_Multiplier);
            label.setPosition(this._currentBonus.x - 15, this._currentBonus.y + 300);
            this.addChild(label);

            var valueLabel = new cc.LabelBMFont(cc.GlobalSlotAladdin.FormatGold(this._totalBonus), cc.SlotAladdinRes.font.Bonus_Multiplier);
            ...
            //         continue;
            //     }
            //     var subLabel = new cc.LabelBMFont(this._bonusArray[resultIndex], cc.SlotAladdinRes.font.Bay_Buom_Stroke_White);
