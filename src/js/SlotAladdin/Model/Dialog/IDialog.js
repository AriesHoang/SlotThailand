...
(function () {
    SlotAladdin.Dialog = cc.Node.extend({
        ...
        _initWithSize: function (size, y) {
            ...
            // title
            // var title = new cc.LabelBMFont("", cc.SlotAladdinRes.font.Bay_Buom_Text_Stroke);
            var title = new cc.LabelTTF("", cc.SlotAladdinRes.font.UVNThangVu, 50, cc.p(400, 300), cc.TEXT_ALIGNMENT_CENTER, cc.VERTICAL_TEXT_ALIGNMENT_CENTER);
        ...
        initBackground: function (w, h) {
            // background
            var dialogBg = new cc.Sprite("res/SlotAladdin/bg_popup.png");
            dialogBg.setPosition(this.width / 2 - 5, this.height / 2 + 105);
        ...
        initButton: function () {
            var closeBtn = new ccui.Button("slotaladdin_x_down.png", "slotaladdin_x_down.png", "", ccui.Widget.PLIST_TEXTURE);
