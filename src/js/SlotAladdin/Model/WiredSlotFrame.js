...
(function () {
    var SlotFrame = SlotAladdin.SlotFrame;
    ...
    SlotAladdin.WiredSlotFrame = SlotFrame.extend({
        ...
        _implementWires: function () {
            ...
            for (var i = 0; i < this.wires.length; i++) {
                var w = new cc.Sprite("res/SlotAladdin/payline/Payline_" + (i + 1) + ".png");
                // if (i === 0)
                //     w.setPosition(-20, 50);
                // else if (i === 1)
        ...
        _revealSymbol: function (symbolValue) {
            ...
            for (var i = 0; i < this.column; i++) {
                for (var j = 0; j < this.row; j++) {
                    ...
                    // var eff = sp.SkeletonAnimation.createWithJsonFile("res/SlotAladdin/spine/effect_sym_fire.json", "res/SlotAladdin/spine/effect_sym_fire.atlas");
