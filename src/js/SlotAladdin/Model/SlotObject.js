...
(function () {
    ...
    var SlotObject = cc.Sprite.extend({
        ctor: function (value) {
            ...
            //var label = new cc.LabelBMFont(value, cc.SlotAladdinRes.font.Arial_Stroke_Number_100);
...
//export getter/setter
    ...
    SlotAladdin.AllSlotObject = AllSlotObject;
    SlotAladdin.SlotObject = SlotObject;
})();
