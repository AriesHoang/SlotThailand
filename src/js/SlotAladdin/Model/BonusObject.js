...
(function () {
    SlotAladdin.BonusObject = cc.Node.extend({
        ctor: function () {
            this._super();
            var value = value || cc.GlobalSlotAladdin.randomInt(1, 12);
            value = value % 12 + 1;

            this._revealed = false;

            // var natra = sp.SkeletonAnimation.createWithJsonFile("res/SlotAladdin/spine/effect_lotus.json", "res/SlotAladdin/spine/effect_lotus.atlas");
            // var hold = new cc.Sprite("#slotwomenagent_bonus_shoot_hold.png");
            var hold = new cc.Sprite("#slotaladdin_treasure" + value+".png");
            this.addChild(hold);
            // hold.setSkin(value);
        ...
        showMoneyBonus: function (str, pos, callback) {
            var flyingLabel = new cc.LabelBMFont(cc.GlobalSlotAladdin.FormatGold(str), cc.SlotAladdinRes.font.Bonus_Multiplier);
            flyingLabel.y += 50;
        ...
        showTextBonus: function () {
            var finishLabel = new cc.LabelBMFont("MISS", cc.SlotAladdinRes.font.PopupFont);
            finishLabel.x += 20;
            finishLabel.y += 50;
