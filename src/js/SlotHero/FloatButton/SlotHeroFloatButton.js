var SlotHeroFloatButton = (function () {
    var instance = null;

    var SlotHeroExpandedFloatBtn = cc.Node.extend({
        ctor: function () {
            this._super();
        ...
        initMinigameList: function () {
            var listMinigame = cc.GlobalSlotHero.miniGameData;
    ...
    var SlotHeroFloatButtonClass = cc.Node.extend({
        ctor: function () {
            if (instance) {
            ...
            var bg = new cc.Sprite("#slothero_minigame_btn.png");
        ...
        show: function (parent) {
            ...
            this.bg.setSpriteFrame("slothero_minigame_btn.png");
        ...
        expand: function () {
            this.expanded = true;
            this.visible = false;
            var expandedNode = new SlotHeroExpandedFloatBtn();
    ...
    SlotHeroFloatButtonClass.getInstance = function () {
        if (!instance) {
            instance = new SlotHeroFloatButtonClass();
            instance.retain();
        }
        return instance;
    };

    return SlotHeroFloatButtonClass;
