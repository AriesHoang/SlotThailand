...
(function () {
    var res = SlotHero.res;
    var res_initial = SlotHero.res_initial;
    var res_texture = SlotHero.res_texture;

    SlotHero.LoadingScene = cc.Scene.extend({
        ctor: function () {
            this._super();
            ...
            var loadingLabel = new cc.Sprite("res/SlotHero/loading.png");
        ...
        loadResources: function (index) {
            ...
            cc.loader.load(res[index], function (err, result) {
                ...
                if (index < res.length) {
                    ...
                    SlotHero.SlotClient.getInstance().connect();
                }
            });
        },

        onReconnect: function () {
            // var scene = new SlotHero.SlotScene();
