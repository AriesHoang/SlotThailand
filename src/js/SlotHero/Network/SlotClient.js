...
(function () {
    SlotHero.SlotClient = (function () {
        ...
        var Clazz = cc.Class.extend({
            ...
            checkAndReconnect: function () {
                ...
                do {
                    ...
                    this._connectTimeout = setTimeout(function () {
                        ...
                        if (scene) {
                            var l = new SlotHero.LoadingLayer("NOTIFICATION", "Unable to connect to the server.\nThe system will reconnect in a moment.");
            ...
            getToken: function () {
                if (cc.GlobalSlotHero.AccessToken)
                    return cc.GlobalSlotHero.AccessToken;
            ...
            sendExtensionRequestCurrentRoom: function (command, params) {
                if (SlotHero.SFS.roomId < 0)
                    return;
                this.sendExtensionRequest(SlotHero.SFS.roomId, command, params);
            }
        });
