...
(function () {
    var Popup = SlotHero.Popup;
    var X2Controller = SlotHero.X2Controller;
    SlotHero.X2Popup = Popup.extend({
        ctor: function (potentialReward,baseReward) {
            ...
            var bg = new cc.Sprite("res/SlotHero/main_background.png");
            ...
            var expectLabel = new cc.LabelBMFont(cc.GlobalSlotHero.FormatGold(potentialReward), cc.SlotHeroRes.font.Bay_Buom_X2Popup);
            ...
            var totalWinLabel = new cc.LabelBMFont("0", cc.SlotHeroRes.font.Bay_Buom_Stroke_White);
        ...
        showWinGame: function (amount,expected) {
            ...
            this.expectLabel.setString(cc.GlobalSlotHero.FormatGold(expected));
            this._pending = false;
        ...
        setTotalWin: function (value) {
            this.totalWinLabel.setString(cc.GlobalSlotHero.FormatGold(value));
        },
