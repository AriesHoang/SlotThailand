...
(function () {
    SlotHero.GoldenTime = cc.Sprite.extend({
        ctor: function () {
            this._super("#slothero_golden_time.png");
            var xLabel = new cc.LabelBMFont("", cc.SlotHeroRes.font.FreeSpinFont);
            xLabel.setPosition(this.width / 2, 120);
            // xLabel.setScale(0.8);
            this.addChild(xLabel);
            this.xLabel = xLabel;

            var timeLabel = new cc.LabelBMFont("", cc.SlotHeroRes.font.HappyHourFont);
            timeLabel.setPosition(this.width / 2, 55);
            // timeLabel.setScale(0.55);
            this.addChild(timeLabel);
            this.timeLabel = timeLabel;

            // var dateLabel = new cc.LabelBMFont("111d", cc.SlotHeroRes.font.Bay_Buom_Stroke_White);
