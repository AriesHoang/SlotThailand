...
(function () {
    var SlotObject = SlotHero.SlotObject;
    var AllSlotObject = SlotHero.AllSlotObject;
    SlotHero.SlotFrame = cc.Node.extend({
        ...
        _initSlotFrame: function () {
            ...
            // var slotBackground = new cc.Sprite("res/SlotHero/slotmhv_frame_bg.png");
            var slotFrame = new cc.Sprite("res/SlotHero/bg_popup.png");
            ...
            for (var i = 0; i < row * column; i++) {
                var slotObj = new SlotObject(cc.GlobalSlotHero.randomInt(0, 10));
            ...
            for (var i = 0; i < (row + 2) * column; i++) {
                var rollingSlotObj = new cc.Sprite("#Sym_" + AllSlotObject[cc.GlobalSlotHero.randomInt(0, 10)] + ".png");
