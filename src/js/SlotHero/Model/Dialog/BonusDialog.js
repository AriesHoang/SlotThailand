...
(function () {
    ...
    SlotHero.BonusDialog = Dialog.extend({
        ctor: function (width, height) {
            ...
            var gun1 = new cc.Sprite("#slothero_genie2.png");
            var gun1bg = new cc.Sprite("#slothero_genie2.png");
            ...
            var gun2 = new cc.Sprite("#slothero_genie1.png");
            var gun2bg = new cc.Sprite("#slothero_genie1.png");
            ...
            var gun3 = new cc.Sprite("#slothero_genie3.png");
            var gun3bg = new cc.Sprite("#slothero_genie3.png");
            ...
            var bottomTip = new cc.Sprite("#slothero_pickitem_title.png");
        ...
        revealBonus: function () {
            ...
            var label = new cc.LabelBMFont("X" + value, cc.SlotHeroRes.font.Bonus_Multiplier);
            label.setPosition(this._currentBonus.x - 15, this._currentBonus.y + 300);
            this.addChild(label);

            var valueLabel = new cc.LabelBMFont(cc.GlobalSlotHero.FormatGold(this._totalBonus), cc.SlotHeroRes.font.Bonus_Multiplier);
            ...
            //         continue;
            //     }
            //     var subLabel = new cc.LabelBMFont(this._bonusArray[resultIndex], cc.SlotHeroRes.font.Bay_Buom_Stroke_White);
