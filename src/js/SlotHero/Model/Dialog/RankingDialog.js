...
(function () {
    ...
    var RankingController = SlotHero.RankingController;
    SlotHero.RankingDialog = HistoryDialog.extend({
        ctor: function () {
            var width = 1178;
            var height = 658;
        ...
        setLogo: function () {
            var title = new cc.Sprite("#slothero_topwinner_title.png");
        ...
        initHeader: function () {
            ...
            var time = new cc.Sprite("#slothero_time_title.png");
            time.setPosition(267, 560);
            this.mainLayer.addChild(time);

            var phong = new cc.Sprite("#slothero_room_title.png");
            phong.setPosition(452, time.y);
            this.mainLayer.addChild(phong);

            var account = new cc.Sprite("#slothero_account_title.png");
            account.setPosition(651, time.y);
            this.mainLayer.addChild(account);

            var jackpot = new cc.Sprite("#slothero_jackpots_title.png");
            jackpot.setPosition(829, time.y);
            this.mainLayer.addChild(jackpot);

            var sodongan = new cc.Sprite("#slothero_win_title.png");
        ...
        initResultItem: function (result) {
            ...
            for (var i = 0; i < result.length; i++) {
                ...
                var account = new cc.LabelBMFont(entry.username, cc.SlotHeroRes.font.PopupFont);
                account.setPosition(309, time.y);
                container.addChild(account);

                var room = new cc.LabelBMFont(cc.GlobalSlotHero.FormatGold(entry.betLevel), cc.SlotHeroRes.font.PopupFont);
                room.setPosition(492, time.y);
                container.addChild(room);

                var reward = new cc.LabelBMFont(cc.GlobalSlotHero.FormatGold(entry.totalReward), cc.SlotHeroRes.font.PopupFont);
                ...
                var description = new cc.LabelBMFont(str, cc.SlotHeroRes.font.PopupFont);
