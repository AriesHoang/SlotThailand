...
(function () {
    SlotHero.Dialog = cc.Node.extend({
        ...
        _initWithSize: function (size, y) {
            ...
            // title
            // var title = new cc.LabelBMFont("", cc.SlotHeroRes.font.Bay_Buom_Text_Stroke);
            var title = new cc.LabelTTF("", cc.SlotHeroRes.font.UVNThangVu, 50, cc.p(400, 300), cc.TEXT_ALIGNMENT_CENTER, cc.VERTICAL_TEXT_ALIGNMENT_CENTER);
        ...
        initBackground: function (w, h) {
            // background
            var dialogBg = new cc.Sprite("res/SlotHero/bg_popup.png");
        ...
        initButton: function () {
            var closeBtn = new ccui.Button("slothero_x_down.png", "slothero_x_down.png", "", ccui.Widget.PLIST_TEXTURE);
