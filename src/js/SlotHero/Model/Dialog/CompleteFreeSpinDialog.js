...
(function () {
    ...
    SlotHero.CompleteFreeSpinDialog = Dialog.extend({
        ...
        initLabels: function (turnCount, reward) {
            var turnCountLabel = new cc.LabelBMFont(turnCount, cc.SlotHeroRes.font.Bonus_Result);
            turnCountLabel.setPosition(606, 470);
            this.addChild(turnCountLabel, 100);

            var rewardLabel = new cc.LabelBMFont(cc.GlobalSlotHero.FormatGold(reward), cc.SlotHeroRes.font.Bonus_Result);
