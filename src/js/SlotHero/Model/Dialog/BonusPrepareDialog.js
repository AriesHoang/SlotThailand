...
(function () {
    ...
    SlotHero.BonusPrepareDialog = Dialog.extend({
        ctor: function (betLevel, width, height) {
            ...
            var iconGame = new cc.Sprite("#slothero_genie_title.png");
            iconGame.setPosition(cc.winSize.width / 2, cc.winSize.height / 2 + 236);
            this.addChild(iconGame);

            var countDownLabel = new cc.LabelBMFont("Auto play in 9s... ", cc.SlotHeroRes.font.PopupFont);
        ...
        initButton: function () {
            var haiBtn = new ccui.Button("slothero_btn_choi.png", "slothero_btn_choi.png", "", ccui.Widget.PLIST_TEXTURE);
