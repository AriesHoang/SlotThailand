...
(function () {
    SlotHero.LoadingLayer = cc.Node.extend({
        ctor: function (title, content) {
            ...
            var body = new cc.Sprite("#slothero_dialog_frame.png");
            // body.x += 75;
            body.setScale(1);
            this.addChild(body);
            ...
            var agreeLabel = new cc.LabelBMFont("OK", cc.SlotHeroRes.font.PopupFont);
        ...
        initLabels: function (title, content) {
            // cc.log("titleLabel");
            var titleLabel = new cc.LabelBMFont(title, cc.SlotHeroRes.font.PopupFont);
            titleLabel.setScale(1.2);
            titleLabel.setPosition(20, 150);
            this.addChild(titleLabel);

            // cc.log("contentLabel");
            var contentLabel = new cc.LabelBMFont(content, cc.SlotHeroRes.font.PopupFont);
