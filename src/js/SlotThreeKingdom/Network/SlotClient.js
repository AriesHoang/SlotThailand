...
(function () {
    SlotThreeKingdom.SlotClient = (function () {
        var instance = null;
        var CONNECTING = 0;
        var OPEN = 1;
        var CLOSING = 2;
        ...
        var Clazz = cc.Class.extend({
            ...
            checkAndReconnect: function () {
                ...
                do {
                    ...
                    this._connectTimeout = setTimeout(function () {
                        ...
                        if (scene) {
                            var l = new SlotThreeKingdom.LoadingLayer("NOTIFICATION", "Unable to connect to the server.\nThe system will reconnect in a moment.");
            ...
            getToken: function () {
                if (cc.GlobalSlotThreeKingdom.AccessToken)
                    return cc.GlobalSlotThreeKingdom.AccessToken;
            ...
            _onJoinRoomListener: function (msgType, data) {
                SlotThreeKingdom.SFS.roomId = data["p"]["1"];
                var scene = cc.director.getRunningScene();
            ...
            sendExtensionRequestCurrentRoom: function (command, params) {
                if (SlotThreeKingdom.SFS.roomId < 0)
                    return;
                this.sendExtensionRequest(SlotThreeKingdom.SFS.roomId, command, params);
            }
        });
