...
(function () {
    ...
    SlotThreeKingdom.HistoryController = BaseController.extend({
        ctor: function () {
            this._super.apply(this, arguments);
            SlotThreeKingdom.SlotClient.getInstance().addExtensionListener("60", this.onDataReceived, this);
        ...
        sendRequestData: function (page) {
            SlotThreeKingdom.SlotClient.getInstance().sendExtensionRequestCurrentRoom("60", {1: page * 10, 2: 10});
        },

        sendRequestDetail: function (session) {
            SlotThreeKingdom.SlotClient.getInstance().sendExtensionRequestCurrentRoom("22", {1: session});
        },
