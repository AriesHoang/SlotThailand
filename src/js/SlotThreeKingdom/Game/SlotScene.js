...
(function () {
    ...
    var SlotController = SlotThreeKingdom.SlotController;
    var WiredSlotFrame = SlotThreeKingdom.WiredSlotFrame;
    var SettingItem = SlotThreeKingdom.SettingItem;
    var FreeSpinNode = SlotThreeKingdom.FreeSpinNode;
    var GoldenTime = SlotThreeKingdom.GoldenTime;
    var MainButton = SlotThreeKingdom.MainButton;
    var HistoryDialog = SlotThreeKingdom.HistoryDialog;
    var RankingDialog = SlotThreeKingdom.RankingDialog;
    var RewardDialog = SlotThreeKingdom.RewardDialog;
    var CompleteFreeSpinDialog = SlotThreeKingdom.CompleteFreeSpinDialog;
    var X2Popup = SlotThreeKingdom.X2Popup;
    ...
    var SlotScene = BaseScene.extend({
        ctor: function (row, column) {
            ...
            SlotThreeKingdom.Lines && slotFrame.setWires(SlotThreeKingdom.Lines);
            this.slotFrame = slotFrame;
            slotFrame.setPosition(cc.winSize.width / 2, cc.winSize.height / 2 - 40);
            this.gameLayer.addChild(slotFrame);
            if (cc.GlobalSlotThreeKingdom.lastResult)
                slotFrame.setResult(cc.GlobalSlotThreeKingdom.lastResult);

            // var btmBar = new ccui.Scale9Sprite("SlotThreeKingdom_slot_btm_bar.png", cc.rect(0, 0, 1, 1));
            ...
            // var logo = new cc.Sprite("res/SlotThreeKingdom/SlotThreeKingdom_logo_game.png");
            ...
            this.setSelectedLines(cc.GlobalSlotThreeKingdom.SlotState.lines || defaultLines);
            this.setFreeSpinCount(0);
            thiz.setBetLevel(cc.GlobalSlotThreeKingdom.SlotState.betLevel || 0, cc.GlobalSlotThreeKingdom.isSandboxMode || isNaN(cc.GlobalSlotThreeKingdom.SlotState.betLevel) === false);
            this.setTotalWin(cc.GlobalSlotThreeKingdom.totalRewardValue || 0, true, true, true);
            this.setCredit(cc.GlobalSlotThreeKingdom.PlayerGold);
            this.setState(SlotState.IDLE);

            // this.initCheatLayer();

            this._performPendingFSAction();
            this.setSession(cc.GlobalSlotThreeKingdom.sessionId);

            if (cc.GlobalSlotThreeKingdom.FreeSpinCount)
                this.setFreeSpinCount(cc.GlobalSlotThreeKingdom.FreeSpinCount);
            if (cc.GlobalSlotThreeKingdom.PortalFreeSpinCount)
                this.setPortalFreeSpinCount(cc.GlobalSlotThreeKingdom.PortalFreeSpinCount);
            else if (cc.GlobalSlotThreeKingdom.FreeSpinGame.enabled && cc.GlobalSlotThreeKingdom.FreeSpinCount === 0)
                this.showCompleteFreeSpinDialog();

            if (cc.GlobalSlotThreeKingdom.AutoSpin)
                this.toggleAutoSpin();

            if (cc.GlobalSlotThreeKingdom.FastRoll)
                this.toggleFastRoll();

            if (cc.GlobalSlotThreeKingdom.isSandboxMode) {
                this.switchToSandbox(cc.GlobalSlotThreeKingdom.PlayerGold);
                this._setJackPotLabel(cc.GlobalSlotThreeKingdom.sandboxJackpot);
            }
            ...
            //ShowMinigame Butotn
            SlotThreeKingdomFloatButton.getInstance().show(this);
            //Hide all Minigame
        ...
        testShowLine: function () {
            // for (var i = 1; i < 2; i++) {
            // var wireNode = new cc.Sprite("res/SlotThreeKingdom/payline/payline_25.png");
        ...
        initBackground: function () {
            //background
            var background = new cc.Sprite("res/SlotThreeKingdom/main_background.png");
            cc.GlobalSlotThreeKingdom.scaleBackground(background);
        ...
        initGUI: function () {
            var jackpotLabel = new cc.LabelBMFont("500,000", cc.SlotThreeKingdomRes.font.JackpotFont);
            jackpotLabel.setPosition(cc.winSize.width / 2, cc.winSize.height / 2 + 380);
            ...
            creditBg.setPosition(400, cc.winSize.height - 80);
            creditBg.setScale(0.45);
            creditBg.setScaleY(0.40);
            this.gameLayer.addChild(creditBg);

            var creditLabel = new cc.LabelBMFont("0", cc.SlotThreeKingdomRes.font.ResultFont);
            creditLabel.setPosition(creditBg.x + 10, creditBg.y + 20);
            creditLabel.setColor(cc.color(217,61,43));
            creditLabel.setScale(0.8)

            this.gameLayer.addChild(creditLabel, 1);
            this.creditLabel = creditLabel;

            var lineLabel = new cc.LabelBMFont("20", cc.SlotThreeKingdomRes.font.ResultFont);
            lineLabel.setPosition(290, 65);
            this.gameLayer.addChild(lineLabel, 1);
            this.lineLabel = lineLabel;

            var betLevelLabel = new cc.LabelBMFont("100,000", cc.SlotThreeKingdomRes.font.ResultFont);
            ...
            var totalBetLabel = new cc.LabelBMFont("0", cc.SlotThreeKingdomRes.font.ResultFont);
            ...
            var totalRewardLabel = new cc.LabelBMFont("0", cc.SlotThreeKingdomRes.font.ResultFont);
            ...
            sessionBg.setPosition(cc.winSize.width - 410, cc.winSize.height - 80);
            sessionBg.setScale(0.45);
            sessionBg.setScaleY(0.4);
            this.gameLayer.addChild(sessionBg);

            var sessionLabel = new cc.LabelBMFont("# 123", cc.SlotThreeKingdomRes.font.CreditFont);
            sessionLabel.setPosition(sessionBg.x + 10, sessionBg.y + 20);
            sessionLabel.setColor(cc.color(0,0,0));
            ...
            btnDong.addClickEventListener(function () {
                ...
                if (!thiz.musicSetting.getDisabled())
                    SlotThreeKingdomSoundPlayer.playSound("spin_button_press", false);
            });
            ...
            // var cuocLabel = new cc.LabelBMFont("CƯỢC", cc.SlotThreeKingdomRes.font.Bay_Buom_Text_Stroke);
            // var cuocLabel = new cc.LabelTTF("CƯỢC", cc.SlotThreeKingdomRes.font.UVNThangVu, 35);
            // var cuocLabel = new cc.LabelTTF(MultiLanguage.getTextByKey("BET_TITLE"), cc.SlotThreeKingdomRes.font.UVNThangVu, 38, cc.p(200, 200), cc.TEXT_ALIGNMENT_CENTER, cc.VERTICAL_TEXT_ALIGNMENT_CENTER);
            ...
            // var sandboxText1 = new cc.LabelTTF("TRAIL PLAY", cc.SlotThreeKingdomRes.font.UVNThangVu, 35);
            ...
            var portalFSCount = new cc.LabelBMFont("0", cc.SlotThreeKingdomRes.font.FreeSpinFont);
            // var portalFSCount = new cc.LabelTTF("0", "Arial", 40);
            portalFSCount.setPosition(105, 110);
            portalFreeSpin.addChild(portalFSCount);

            // var portalFS = new cc.LabelTTF(MultiLanguage.getTextByKey("FREE_SPIN_TITLE"), cc.SlotThreeKingdomRes.font.UVNThangVu, 35);
        ...
        initButton: function () {
            ...
            homeBtn.setPosition(130, cc.winSize.height - 90);
            ...
            // var sandboxText = new cc.LabelTTF("TRAIL PLAY", cc.SlotThreeKingdomRes.font.UVNThangVu, 35);
            ...
            // var autoRollLabel = new cc.LabelBMFont("QUAY\n\nTỰ ĐỘNG", cc.SlotThreeKingdomRes.font.Bay_Buom_Text_Stroke);
            // var autoRollLabel = new cc.LabelTTF("QUAY\nTỰ ĐỘNG", cc.SlotThreeKingdomRes.font.UVNThangVu, 38);
            // var autoRollLabel = new cc.LabelTTF(MultiLanguage.getTextByKey("AUTO_ROLL_TITLE"), cc.SlotThreeKingdomRes.font.UVNThangVu, 38);
            ...
            // var rollBtn = new ccui.Button("SlotThreeKingdom_roll_btn.png", "", "", ccui.Widget.PLIST_TEXTURE);
            // rollBtn.setZoomScale(0);
            // rollBtn.setPosition(cc.winSize.width - 200, rollBtn.height / 2);
            // this.gameLayer.addChild(rollBtn);

            // var rollSpine = sp.SkeletonAnimation.createWithJsonFile("res/SlotThreeKingdom/spine/effect_spin.json", "res/SlotThreeKingdom/spine/effect_spin.atlas");
            ...
            // var rollSprite = new cc.Sprite("res/SlotThreeKingdom/SlotThreeKingdom_btn_roll.png");
...
//
            ...
            settingBtn.setPosition(rankingBtn.x + 100, rankingBtn.y);
            ...
            // var x2Sprite = new cc.Sprite("#SlotThreeKingdom_x2_btn.png");
            ...
            homeBtn.addClickEventListener(function () {
                ...
                if (!thiz.musicSetting.getDisabled())
                    SlotThreeKingdomSoundPlayer.playSound("spin_button_press", false);
                // cc.log("GOTOHOME-------------");
                SlotThreeKingdom.SlotClient.getInstance().closeSocket();
                //Hide all Minigame
                MiniGameNavigator.hideAll();
                SlotThreeKingdomSoundPlayer.stopSound("theme_hauvuong");
                SlotThreeKingdomSoundPlayer.stopSound("spin");
                thiz.autoSpin = false;
        ...
        initCharacter: function () {
            // var wukong = sp.SkeletonAnimation.createWithJsonFile("res/SlotThreeKingdom/spine/wukong.json", "res/SlotThreeKingdom/spine/wukong.atlas");
            // wukong.setPosition(230, cc.winSize.height / 2 - 350);
            // wukong.setScale(1);
            // wukong.setAnimation(0, "animation", true);
            var agent = new cc.Sprite("res/SlotThreeKingdom/agent.png");
            agent.setPosition(190, cc.winSize.height / 2 - 80);
            // wukong.setScale(1);
            this.gameLayer.addChild(agent);

            var lancan = new cc.Sprite("res/SlotThreeKingdom/lancan.png");
            lancan.setPosition(150, 240);
            lancan.setVisible(false);
            this.gameLayer.addChild(lancan);

            // var peach = sp.SkeletonAnimation.createWithJsonFile("res/SlotThreeKingdom/spine/effect_peach.json", "res/SlotThreeKingdom/spine/effect_peach.atlas");
        ...
        toggleAutoSpin: function () {
            ...
            this.autoRollBtn.loadTextureNormal(this.autoSpin ? "slotwomenagent_auto_roll_btn.png" : "slotwomenagent_auto_roll_btn_inactive.png",
                ccui.Widget.PLIST_TEXTURE);
            if (this.autoSpin && this.state === SlotState.IDLE)
                this.onQuayBtnClick();

            cc.GlobalSlotThreeKingdom.AutoSpin = this.autoSpin;
        },
        ...
        toggleFastRoll: function () {
            ...
            cc.GlobalSlotThreeKingdom.FastRoll = this.fastRoll;
        },
        ...
        setCredit: function (value) {
            ...
            this._pendingCredit = function () {
                ...
                SlotThreeKingdom.runActionNumber(thiz.creditLabel, cc.GlobalSlotThreeKingdom.PlayerGold, thiz._oldCreditValue);
                thiz._oldCreditValue = cc.GlobalSlotThreeKingdom.PlayerGold;

                thiz._pendingCredit = null;
            };

            if (bet < 0) {
                cc.GlobalSlotThreeKingdom.PlayerGold = money;
                this._pendingCredit();
            } else if (bet === 0) {
                cc.GlobalSlotThreeKingdom.PlayerGold = money;
                this._pendingCredit();
        ...
        setSelectedLines: function (selectedLines) {
            ...
            if (selectedLines instanceof Array && selectedLines.length > 0) {
                ...
                this.totalBetLabel.setString(cc.GlobalSlotThreeKingdom.FormatGold(
                    this.allBetLevel[this.betLevel] * this.selectedLines.length));

                cc.GlobalSlotThreeKingdom.SlotState.lines = this.selectedLines;
            }
        ...
        onQuayBtnClick: function (cheatType) {
            ...
            if (this.portalFreeSpinCount) {
                ...
                cc.GlobalSlotThreeKingdom.FreeSpinGame.enabled = true;
                cc.GlobalSlotThreeKingdom.FreeSpinGame.count++;
            ...
            if (!this.musicSetting.getDisabled())
                SlotThreeKingdomSoundPlayer.playSound("spin", false);
            ...
            fn(this.betLevel, this.selectedLines, (this.cheatTF) ? this.cheatTF.getString() : null,
                cc.GlobalSlotThreeKingdom.FreeSpinGame.enabled || this.autoSpin);
            // fn(this.betLevel, this.selectedLines, null, cc.GlobalSlotThreeKingdom.FreeSpinGame.enabled || this.autoSpin);
        ...
        showX2Game: function () {
            ...
            var node = new X2Popup(cc.GlobalSlotThreeKingdom.pendingX2Value, cc.GlobalSlotThreeKingdom.pendingX2Base);
            ...
            node.setExitCallback(function (winAmount) {
                ...
                this.setState(SlotState.IDLE);
                cc.GlobalSlotThreeKingdom.totalRewardValue += winAmount;
                this.setTotalWin(cc.GlobalSlotThreeKingdom.totalRewardValue, true, null, true);
                this.x2Btn.visible = false;
            }, this);
        },
        ...
        updateSlotResult: function (result) {
            if (this._isWaitingResult) {
                ...
                cc.GlobalSlotThreeKingdom.pendingX2 = result["x2"];
            }
        },
        ...
        rewardCallback: function (totalResult, result) {
            ...
            var showBonusAction = new cc.CallFunc(function () {
                ...
                if (!thiz.musicSetting.getDisabled())
                    SlotThreeKingdomSoundPlayer.playSound("bonus", false);
                thiz.hideAllDialog();
                effectLayer.visible = true;
                // tnkEffect.visible = false;
                // var effect_win_bonus = sp.SkeletonAnimation.createWithJsonFile('res/SlotThreeKingdom/spine/win_bonus.json', 'res/SlotThreeKingdom/spine/win_bonus.atlas');
                ...
                //     }, 0);
                // });
                var effect_win_bonus = new cc.Sprite("res/SlotThreeKingdom/win/slotthreekingdom_bonus.png");
            ...
            var showFreeSpinAction = new cc.CallFunc(function () {
                ...
                if (!thiz.musicSetting.getDisabled())
                    SlotThreeKingdomSoundPlayer.playSound("freespin_xuathien", false);
                ...
                effectLayer.visible = true;
                // tnkEffect.visible = false;
                // var effect_win_freespin = sp.SkeletonAnimation.createWithJsonFile('res/SlotThreeKingdom/spine/win_freespin.json', 'res/SlotThreeKingdom/spine/win_freespin.atlas');
                ...
                var effect_win_freespin = new cc.Sprite("res/SlotThreeKingdom/win/slotthreekingdom_freespin.png");
                effect_win_freespin.setPosition(cc.winSize.width / 2, cc.winSize.height / 2);
                effectLayer.addChild(effect_win_freespin);

                // var label = new cc.LabelBMFont("+" + totalResult["free_spin_count"] + " LƯỢT QUAY", cc.SlotThreeKingdomRes.font.Dialog_Title);
            ...
            var afterAction = new cc.CallFunc(function () {
                var chainSequence = function () {
                    ...
                    if (totalResult["free_spin"] && totalResult["bonus"]) {
                        ...
                        showFreeSpinAction.release();
                        finishAction.release();
                        cc.GlobalSlotThreeKingdom.pendingFSReward = totalResult["free_spin"];
        ...
        onRollResult: function (result) {
            ...
            cc.GlobalSlotThreeKingdom.lastResult = result["1"];
            for (var i = 0; i < this.slotFrame.column; i++) {
                setTimeout(function (index) {
            ...
            setTimeout(function () {
                ...
                var chainSequence = function () {
                    ...
                    var showLineReward = cc.callFunc(function () {
                        ...
                        slotFrame.showReward(thiz.fastRoll, result["2"], result["free_spin"], result["bonus"], function (shownLine) {
                            if (shownLine.type === 2) {
                                if (!thiz.musicSetting.getDisabled())
                                    SlotThreeKingdomSoundPlayer.playSound("win_small", false);
                    ...
                    //     + "\n ------ Global freeSpinCount------: " + cc.GlobalSlotThreeKingdom.FreeSpinGame.count);
                    ...
                    if (!result["free_spin"]
                        ...
                        && (cc.GlobalSlotThreeKingdom.FreeSpinGame.count === 0 || cc.GlobalSlotThreeKingdom.FreeSpinGame.count === undefined)) {
                ...
                var showBigWinAction = new cc.CallFunc(function () {
                    ...
                    if ([2, 3, 4, 5].indexOf(winType) !== -1) {
                        // var label = new cc.LabelBMFont("", cc.SlotThreeKingdomRes.font.Total_Reward_Font);
                        ...
                        SlotThreeKingdom.runActionNumber(label, rewardValue);
                        effectLayer.addChild(label);
                        // effect.setScale(0.8);
                    }
                    ...
                    switch (winType) {
                        case 2:
                            // cc.log("case2");
                            if (!thiz.musicSetting.getDisabled())
                                SlotThreeKingdomSoundPlayer.playSound("win_medium", false);
                            effectLayer.visible = true;
                            // var effect_win_rich = sp.SkeletonAnimation.createWithJsonFile('res/SlotThreeKingdom/spine/win_rich.json', 'res/SlotThreeKingdom/spine/win_rich.atlas');
                            ...
                            var effect_win_rich = new cc.Sprite("res/SlotThreeKingdom/win/slotthreekingdom_epicwin.png");
                        ...
                        case 4:
                            // cc.log("case34");
                            if (!thiz.musicSetting.getDisabled())
                                SlotThreeKingdomSoundPlayer.playSound("win_large", false);
                            effectLayer.visible = true;
                            // var effect_win_big = sp.SkeletonAnimation.createWithJsonFile('res/SlotThreeKingdom/spine/win_big.json', 'res/SlotThreeKingdom/spine/win_big.atlas');
                            ...
                            //     chainSequence();
                            // });
                            var effect_win_big = new cc.Sprite("res/SlotThreeKingdom/win/slotthreekingdom_megawin.png");
                        ...
                        case 5:
                            ...
                            effectLayer.visible = true;
                            if (!thiz.musicSetting.getDisabled())
                                SlotThreeKingdomSoundPlayer.playSound("jackpot_xuathien", false);
                            // thiz.totalRewardLabel.setString(cc.GlobalSlotThreeKingdom.FormatGold(rewardValue));
                            // var effect_win_jackpot = sp.SkeletonAnimation.createWithJsonFile('res/SlotThreeKingdom/spine/win_jackpot.json', 'res/SlotThreeKingdom/spine/win_jackpot.atlas');
                            ...
                            //     // effect_win_big.setScale(1);
                            //     if (!thiz.musicSetting.getDisabled())
                            //         SlotThreeKingdomSoundPlayer.playSound("jackpot_ketthuc", false);
                            //     chainSequence();
                            // });

                            var effect_win_jackpot = new cc.Sprite("res/SlotThreeKingdom/win/slotthreekingdom_jackpotwin.png");
        ...
        setBetLevel: function (betId, noRequest) {
            ...
            if (~[0, 1, 2].indexOf(betId)) {
                this.betLevel = betId;
                this.betLevelLabel.setString(cc.GlobalSlotThreeKingdom.FormatGold(this.allBetLevel[betId]));
                this.totalBetLabel.setString(cc.GlobalSlotThreeKingdom.FormatGold(this.allBetLevel[betId] * this.selectedLines.length));
                this._setJackPotLabel(this.jackpotValues[this.betLevel]);

                if (!noRequest)
                    this._controller.sendSetBetLevelRequest(betId);

                cc.GlobalSlotThreeKingdom.SlotState.betLevel = this.betLevel;
        ...
        updateBetAmount: function (allBetLevel) {
            ...
            this.betLevelLabel.setString(cc.GlobalSlotThreeKingdom.FormatGold(this.allBetLevel[this.betLevel]));
            this.totalBetLabel.setString(cc.GlobalSlotThreeKingdom.FormatGold(this.allBetLevel[this.betLevel] * this.selectedLines.length));
        },
        ...
        _setJackPotLabel: function (value) {
            ...
            SlotThreeKingdom.runActionNumber(this.jackpotLabel, value, this._oldJackpotValue);
            this._oldJackpotValue = value;

            if (this.isSandboxMode)
                cc.GlobalSlotThreeKingdom.sandboxJackpot = value;
        },
        ...
        setPendingPortalFreeSpinCount: function (count) {
            var thiz = this;
            cc.GlobalSlotThreeKingdom.PortalFreeSpinCount = count;
        ...
        setPendingFreeSpinCount: function (count) {
            var thiz = this;
            cc.GlobalSlotThreeKingdom.FreeSpinCount = count;
        ...
        configLine: function (lines) {
            SlotThreeKingdom.Lines && this.slotFrame.setWires(lines);
        },
        ...
        setTotalWin: function (value, hideEffect, jackpotValue, isRaw, skipFSReward) {
            ...
            cc.GlobalSlotThreeKingdom.totalRewardValue = value + jackpotValue;
            if (value === 0) {
                this.totalRewardLabel.setString(cc.GlobalSlotThreeKingdom.FormatGold(value));
            } else if (value > 0) {

                // free spin game
                if (!skipFSReward && cc.GlobalSlotThreeKingdom.FreeSpinGame.enabled)
                    cc.GlobalSlotThreeKingdom.FreeSpinGame.reward += value;

                if (hideEffect) {
                    // this.totalRewardLabel.setString(cc.GlobalSlotThreeKingdom.FormatGold(value + jackpotValue));
                } else {
                    // var bg = new ccui.Scale9Sprite("SlotThreeKingdom_total_reward_bg.png", cc.rect(160, 10, 2, 2));
                    // var bg = new cc.Sprite("#SlotThreeKingdom_total_reward_bg.png");
                    // // bg.setPreferredSize(cc.size(828, 193));
                    // bg.setPosition(993, cc.winSize.height / 2);
                    // this.gameLayer.addChild(bg, 430);

                    var totalLabel = new cc.LabelBMFont(cc.GlobalSlotThreeKingdom.FormatGold(value + jackpotValue), jackpotValue > 0 ? cc.SlotThreeKingdomRes.font.RewardJackpotFont : cc.SlotThreeKingdomRes.font.RewardNormalFont);
                    totalLabel.setPosition(1030, cc.winSize.height / 2);
                    this.gameLayer.addChild(totalLabel, 431);

                    // var decorator = new cc.Sprite("#SlotThreeKingdom_total_reward_decorator.png");
                    ...
                    var callFunc = new cc.CallFunc(function () {
                        ...
                        thiz.totalRewardLabel.setString(cc.GlobalSlotThreeKingdom.FormatGold(value + jackpotValue));
                    });
        ...
        switchToSandbox: function (coin) {
            ...
            this.sandboxBtn.loadTextureNormal("SlotThreeKingdom_sandbox_off_btn.png", ccui.Widget.PLIST_TEXTURE);
            ...
            cc.GlobalSlotThreeKingdom.isSandboxMode = true;
            this.setCredit(coin);
        },
        ...
        quitSandbox: function () {
            ...
            this.sandboxBtn.loadTextureNormal("SlotThreeKingdom_sandbox_btn.png", ccui.Widget.PLIST_TEXTURE);
            // this.sandboxText.setString("TRAIL PLAY");
            // this.sandboxText.setPosition(this.sandboxBtn.width / 2, this.sandboxBtn.height / 2);
            this.sandboxSprite.visible = false;
            cc.GlobalSlotThreeKingdom.isSandboxMode = false;
            cc.GlobalSlotThreeKingdom.sandboxJackpot = undefined
        },

        setSession: function (sessionId) {
            cc.log("setSession ", sessionId)
            this.sessionLabel.setString(sessionId ? ("#" + sessionId) : "");
            cc.GlobalSlotThreeKingdom.sessionId = sessionId;
        },
        ...
        toggleLinesSelect: function () {
            ...
            if (this.selectedLines.length < SlotThreeKingdom.Lines.length) {
        ...
        setState: function (state) {
            ...
            if (state === SlotState.IDLE) {
                ...
                if (cc.GlobalSlotThreeKingdom.pendingX2) {
                    this.setState(SlotState.SHOWING_X2);
                    cc.GlobalSlotThreeKingdom.pendingX2 = undefined;
                    setTimeout(function () {
                        // thiz.showX2Game();
                    }, 2000);
                    return;
        ...
        showCompleteFreeSpinDialog: function () {
            ...
            cc.log(cc.GlobalSlotThreeKingdom.FreeSpinGame.count, cc.GlobalSlotThreeKingdom.FreeSpinGame.reward);
            // var d = new CompleteFreeSpinDialog(cc.GlobalSlotThreeKingdom.FreeSpinGame.count, cc.GlobalSlotThreeKingdom.FreeSpinGame.reward);
        ...
        setPotentialDoubleAmount: function (amount, baseAmount) {
            cc.GlobalSlotThreeKingdom.pendingX2Base = baseAmount;
            cc.GlobalSlotThreeKingdom.pendingX2Value = amount;
        },

        showBonusGame: function () {
            // cc.log("SHOW BONUS GAME");
            cc.director.replaceScene(new SlotThreeKingdom.BonusScene(this.betLevel, this.isSandboxMode));
            SlotThreeKingdomSoundPlayer.stopSound("theme_hauvuong");
        },

        _performPendingFSAction: function () {
            if (!cc.GlobalSlotThreeKingdom.pendingFSReward)
                return;
            ...
            // background effect
            // var effect = sp.SkeletonAnimation.createWithJsonFile('res/SlotThreeKingdom/spine/tnk_win.json', 'res/SlotThreeKingdom/spine/tnk_win.atlas');
            ...
            var effect = sp.SkeletonAnimation.createWithJsonFile('res/SlotThreeKingdom/spine/win_freespin.json', 'res/SlotThreeKingdom/spine/win_freespin.atlas');
            ...
            var label = new cc.LabelBMFont("+" + cc.GlobalSlotThreeKingdom.pendingFSReward + " SPIN", cc.SlotThreeKingdomRes.font.Room_Name);
            label.setScale(2);
            label.setPosition(cc.winSize.width / 2, cc.winSize.height / 2 - 350);
            effectLayer.addChild(label);
            effect.setCompleteListener(function () {
            ...
            cc.GlobalSlotThreeKingdom.pendingFSReward = undefined;
        },
        ...
        onReconnect: function () {
            ...
            this.stopRolling();
            this.setBetLevel(cc.GlobalSlotThreeKingdom.SlotState.betLevel || 0);
        },
        ...
        updateUserChangeMoney: function (eventName, money) {
            if (this.creditLabel) {
                ...
                SlotThreeKingdom.runActionNumber(this.creditLabel, money, cc.GlobalSlotThreeKingdom.PlayerGold);
                cc.GlobalSlotThreeKingdom.PlayerGold = money;
            }
        }
    });

    SlotThreeKingdom.SlotState = SlotState;
    SlotThreeKingdom.SlotScene = SlotScene;
})();
