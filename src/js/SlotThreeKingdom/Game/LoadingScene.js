...
(function () {
    var res = SlotThreeKingdom.res;
    var res_initial = SlotThreeKingdom.res_initial;
    var res_texture = SlotThreeKingdom.res_texture;

    SlotThreeKingdom.LoadingScene = cc.Scene.extend({
        ctor: function () {
            this._super();
            ...
            var loadingLabel = new cc.Sprite("res/SlotThreeKingdom/loading.png");
        ...
        loadResources: function (index) {
            ...
            if (cc.loader.getRes(res[index])) {
                if (index >= res.length - 1) {
                    ...
                    SlotThreeKingdom.SlotClient.getInstance().connect();
                }
                else {
        ...
        onReconnect: function () {
            // var scene = new SlotThreeKingdom.SlotScene();
