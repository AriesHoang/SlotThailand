var SlotThreeKingdomFloatButton = (function () {
    var instance = null;

    var SlotThreeKingdomExpandedFloatBtn = cc.Node.extend({
        ctor: function () {
            this._super();
        ...
        initMinigameList: function () {
            var listMinigame = cc.GlobalSlotThreeKingdom.miniGameData;
    ...
    var SlotThreeKingdomFloatButtonClass = cc.Node.extend({
        ctor: function () {
            if (instance) {
            ...
            var bg = new cc.Sprite("#slotwomenagent_minigame_btn.png");
        ...
        show: function (parent) {
            ...
            this.bg.setSpriteFrame("slotwomenagent_minigame_btn.png");
        ...
        expand: function () {
            this.expanded = true;
            this.visible = false;
            var expandedNode = new SlotThreeKingdomExpandedFloatBtn();
    ...
    SlotThreeKingdomFloatButtonClass.getInstance = function () {
        if (!instance) {
            instance = new SlotThreeKingdomFloatButtonClass();
            instance.retain();
        }
        return instance;
    };

    return SlotThreeKingdomFloatButtonClass;
