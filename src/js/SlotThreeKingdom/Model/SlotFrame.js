...
(function () {
    var SlotObject = SlotThreeKingdom.SlotObject;
    var AllSlotObject = SlotThreeKingdom.AllSlotObject;
    SlotThreeKingdom.SlotFrame = cc.Node.extend({
        ...
        _initSlotFrame: function () {
            ...
            // var slotBackground = new cc.Sprite("res/SlotThreeKingdom/slotmhv_frame_bg.png");
            var slotFrame = new cc.Sprite("res/SlotThreeKingdom/slotwomenagent_frame.png");
            slotFrame.setPositionY(30);
            // slotBackground.x -= 5;
            ...
            clippingSlotLayout.setPosition(slotFrame.x + 5, slotFrame.y - 30);
            /**
             * @type {ccui.Layout}
             */
            ...
            for (var i = 0; i < row * column; i++) {
                var slotObj = new SlotObject(cc.GlobalSlotThreeKingdom.randomInt(0, 10));
            ...
            for (var i = 0; i < (row + 2) * column; i++) {
                var rollingSlotObj = new cc.Sprite("#slotwomenagent_Sym_" + AllSlotObject[cc.GlobalSlotThreeKingdom.randomInt(0, 10)] + ".png");
