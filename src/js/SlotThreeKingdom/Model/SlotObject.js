...
(function () {
    ...
    var SlotObject = cc.Sprite.extend({
        ctor: function (value) {
            ...
            //var label = new cc.LabelBMFont(value, cc.SlotThreeKingdomRes.font.Arial_Stroke_Number_100);
...
//export getter/setter
    ...
    SlotThreeKingdom.AllSlotObject = AllSlotObject;
    SlotThreeKingdom.SlotObject = SlotObject;
})();
