...
(function () {
    ...
    SlotThreeKingdom.PagedDialog = Dialog.extend({
        ...
        initButton: function () {
            ...
            var prevBtn = new ccui.Button("slotwomenagent_arrow.png", "slotwomenagent_arrow.png", "", ccui.Widget.PLIST_TEXTURE);
            prevBtn.setPosition(prevBtn.width / 2 - 100, this.height / 2);
            this.addChild(prevBtn, 1);

            var nextBtn = new ccui.Button("slotwomenagent_arrow.png", "slotwomenagent_arrow.png", "", ccui.Widget.PLIST_TEXTURE);
