...
(function () {
    ...
    var RankingController = SlotThreeKingdom.RankingController;
    SlotThreeKingdom.RankingDialog = HistoryDialog.extend({
        ctor: function () {
            var width = 1178;
            var height = 658;
        ...
        setLogo: function () {
            var title = new cc.Sprite("#slotwomenagent_topwinner_title.png");
        ...
        initHeader: function () {
            ...
            var time = new cc.Sprite("#slotwomenagent_time_title.png");
            time.setPosition(267, 560);
            this.mainLayer.addChild(time);

            var phong = new cc.Sprite("#slotwomenagent_room_title.png");
            phong.setPosition(452, time.y);
            this.mainLayer.addChild(phong);

            var account = new cc.Sprite("#slotwomenagent_account_title.png");
            account.setPosition(651, time.y);
            this.mainLayer.addChild(account);

            var jackpot = new cc.Sprite("#slotwomenagent_jackpots_title.png");
            jackpot.setPosition(829, time.y);
            this.mainLayer.addChild(jackpot);

            var sodongan = new cc.Sprite("#slotwomenagent_win_title.png");
        ...
        initResultItem: function (result) {
            ...
            for (var i = 0; i < result.length; i++) {
                ...
                var account = new cc.LabelBMFont(entry.username, cc.SlotThreeKingdomRes.font.PopupFont);
                account.setPosition(309, time.y);
                container.addChild(account);

                var room = new cc.LabelBMFont(cc.GlobalSlotThreeKingdom.FormatGold(entry.betLevel), cc.SlotThreeKingdomRes.font.PopupFont);
                room.setPosition(492, time.y);
                container.addChild(room);

                var reward = new cc.LabelBMFont(cc.GlobalSlotThreeKingdom.FormatGold(entry.totalReward), cc.SlotThreeKingdomRes.font.PopupFont);
                ...
                var description = new cc.LabelBMFont(str, cc.SlotThreeKingdomRes.font.PopupFont);
