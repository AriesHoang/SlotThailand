...
(function () {
    ...
    SlotThreeKingdom.HistoryDialog = Dialog.extend({
        ctor: function () {
        ...
        setLogo: function () {
            var title = new cc.Sprite("#slotwomenagent_history_title.png");
        ...
        initPage: function () {
            ...
            var prevBtn = new ccui.Button("slotwomenagent_arrow.png", "", "", ccui.Widget.PLIST_TEXTURE);
            prevBtn.setPosition(0, 308);
            this.mainLayer.addChild(prevBtn);

            var nextBtn = new ccui.Button("slotwomenagent_arrow.png", "", "", ccui.Widget.PLIST_TEXTURE);
        ...
        initHeader: function () {
            // var headerBg = new cc.Sprite("#SlotThreeKingdom_history_dialog_header.png");
            ...
            var thoigian = new cc.Sprite("#slotwomenagent_time_title.png");
            thoigian.setPosition(274, phien.y);
            this.mainLayer.addChild(thoigian);

            var betLine = new cc.Sprite("#slotwomenagent_betline_title.png");
            betLine.setPosition(460, phien.y);
            this.mainLayer.addChild(betLine);

            var betLevel = new cc.Sprite("#slotwomenagent_betvalue_title.png");
            betLevel.setPosition(643, phien.y);
            this.mainLayer.addChild(betLevel);

            var rewardLine = new cc.Sprite("#slotwomenagent_payline_title.png");
            rewardLine.setPosition(825, phien.y);
            this.mainLayer.addChild(rewardLine);

            var reward = new cc.Sprite("#slotwomenagent_win_title.png");
        ...
        initDetailHeader: function () {
            ...
            var betLineDetail = new cc.Sprite("#slotwomenagent_betline_title.png");
            betLineDetail.setPosition(296, 565);
            this.detailLayer.addChild(betLineDetail);

            var rewardDetail = new cc.Sprite("#slotwomenagent_win_title.png");
            rewardDetail.setPosition(850, betLineDetail.y);
            this.detailLayer.addChild(rewardDetail);

            var backBtn = new ccui.Button("slotwomenagent_button_back.png", "slotwomenagent_button_back.png", "", ccui.Widget.PLIST_TEXTURE);
        ...
        showResult: function (result) {
            ...
            for (var i = 0; i < result.length; i++) {
                ...
                var session = new cc.LabelBMFont("#" + entry["session"] + "", cc.SlotThreeKingdomRes.font.PopupFont);
                session.setPosition(59, container.height / 2);
                container.addChild(session);

                var time = new cc.LabelBMFont(entry["time"] + "", cc.SlotThreeKingdomRes.font.PopupFont);
                time.setAlignment(cc.TEXT_ALIGNMENT_CENTER);
                time.setPosition(200, session.y);
                container.addChild(time);

                var betCount = new cc.LabelBMFont(entry["betCount"] + "", cc.SlotThreeKingdomRes.font.PopupFont);
                betCount.setPosition(372, session.y);
                container.addChild(betCount);

                var betLevel = new cc.LabelBMFont(cc.GlobalSlotThreeKingdom.FormatGold(entry["betLevel"]) + "", cc.SlotThreeKingdomRes.font.PopupFont);
                betLevel.setPosition(567, session.y);
                container.addChild(betLevel);

                var rewardLine = new cc.LabelBMFont(entry["rewardLine"] + "", cc.SlotThreeKingdomRes.font.PopupFont);
                rewardLine.setPosition(753, session.y);
                container.addChild(rewardLine);

                var reward = new cc.LabelBMFont(cc.GlobalSlotThreeKingdom.FormatGold(entry["reward"]), cc.SlotThreeKingdomRes.font.PopupFont);
                reward.setPosition(899, session.y);
                container.addChild(reward);

                var xemBtn = new ccui.Button("slotwomenagent_button_xem.png", "slotwomenagent_button_xem.png", "", ccui.Widget.PLIST_TEXTURE);
                xemBtn.setPosition(1010, session.y);
        ...
        showDetail: function (details) {
            ...
            for (var i = 0; i < details.length; i++) {
                ...
                var betLine = new cc.LabelBMFont(entry["line"] + "", cc.SlotThreeKingdomRes.font.PopupFont);
