...
(function () {
    ...
    SlotThreeKingdom.BonusPrepareDialog = Dialog.extend({
        ctor: function (betLevel, width, height) {
            ...
            // var upperTip = new cc.Sprite("#SlotThreeKingdom_hautuhaidao.png");
            ...
            var countDownLabel = new cc.LabelBMFont("Auto play in 9s... ", cc.SlotThreeKingdomRes.font.PopupFont);
        ...
        initBackground: function (w, h) {
            ...
            bg.setPosition(this.width / 2, this.height / 2+50);
            this.addChild(bg);
        }
    });
})();
