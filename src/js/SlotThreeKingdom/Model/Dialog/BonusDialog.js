...
(function () {
    ...
    SlotThreeKingdom.BonusDialog = Dialog.extend({
        ctor: function (width, height) {
            ...
            var poses = [
                {x: 678, y: cc.winSize.height / 2},
                {x: 1024, y: cc.winSize.height / 2},
                {x: 1347, y: cc.winSize.height / 2}
            ];
            ...
            var backgroundBonus = new cc.Sprite("#slotthreekingdom_bonus_frame.png");
            backgroundBonus.setPosition(width/2, height/2);
            this.addChild(backgroundBonus);

            var gun1 = new cc.Sprite("#slotthreekingdom_reward_tree_bronze.png");
            var gun1bg = new cc.Sprite("#slotthreekingdom_reward_tree_bronze.png");
            ...
            var gun2 = new cc.Sprite("#slotthreekingdom_reward_tree_silver.png");
            var gun2bg = new cc.Sprite("#slotthreekingdom_reward_tree_silver.png");
            ...
            var gun3 = new cc.Sprite("#slotthreekingdom_reward_tree_gold.png");
            var gun3bg = new cc.Sprite("#slotthreekingdom_reward_tree_gold.png");
            ...
            var bottomTip = new cc.Sprite("#slotthreekingdom_reward_title.png");
            bottomTip.setPosition(1012, cc.winSize.height - 300);
        ...
        revealBonus: function () {
            ...
            var label = new cc.LabelBMFont("X" + value, cc.SlotThreeKingdomRes.font.Bonus_Multiplier);
            label.setPosition(this._currentBonus.x - 15, this._currentBonus.y + 300);
            this.addChild(label);

            var valueLabel = new cc.LabelBMFont(cc.GlobalSlotThreeKingdom.FormatGold(this._totalBonus), cc.SlotThreeKingdomRes.font.Bonus_Multiplier);
            ...
            //         continue;
            //     }
            //     var subLabel = new cc.LabelBMFont(this._bonusArray[resultIndex], cc.SlotThreeKingdomRes.font.Bay_Buom_Stroke_White);
