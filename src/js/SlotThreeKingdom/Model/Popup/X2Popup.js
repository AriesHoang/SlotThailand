...
(function () {
    var Popup = SlotThreeKingdom.Popup;
    var X2Controller = SlotThreeKingdom.X2Controller;
    SlotThreeKingdom.X2Popup = Popup.extend({
        ctor: function (potentialReward,baseReward) {
            ...
            var bg = new cc.Sprite("res/SlotThreeKingdom/main_background.png");
            bg.setPosition(this.width / 2, this.height / 2);
            this.mainLayer.addChild(bg);

            var totalWinBg = new cc.Sprite("#SlotThreeKingdom_total_win_x2.png");
            totalWinBg.setPosition(202, 94);
            this.mainLayer.addChild(totalWinBg);

            var title = new cc.Sprite("#SlotThreeKingdom_tim_gay_nhu_y.png");
            title.setPosition(588, 600);
            this.mainLayer.addChild(title);

            var thang = new cc.Sprite("#SlotThreeKingdom_txt_x2_thang.png");
            thang.setPosition(644, 210);
            thang.visible = false;
            this.mainLayer.addChild(thang);
            this.thang = thang;

            var thua = new cc.Sprite("#SlotThreeKingdom_txt_x2_thua.png");
            ...
            var thiz = this;
            for (var i = 0; i < 4; i++) {
                var thap = new ccui.Button("SlotThreeKingdom_x2_thap.png", "", "", ccui.Widget.PLIST_TEXTURE);
                thap.setZoomScale(0);
                ...
                var gay = new cc.Sprite("#SlotThreeKingdom_x2_gaynhuy.png");
                gay.setPosition(baseGayNhuY.x + i * horizontalOffset, baseGayNhuY.y);
                gay.visible = false;
                this.mainLayer.addChild(gay);
                allGay.push(gay);

                var vong = new cc.Sprite("#SlotThreeKingdom_x2_vongkimco.png");
            ...
            var txtX2 = new cc.Sprite("#SlotThreeKingdom_x2_popup.png");
            txtX2.setPosition(1069, 101);
            this.mainLayer.addChild(txtX2);

            var expectLabel = new cc.LabelBMFont(cc.GlobalSlotThreeKingdom.FormatGold(potentialReward), cc.SlotThreeKingdomRes.font.Bay_Buom_X2Popup);
            ...
            var btnDung = new ccui.Button("SlotThreeKingdom_btn_dung.png", "SlotThreeKingdom_btn_dung_selected.png", "", ccui.Widget.PLIST_TEXTURE);
            btnDung.setPosition(691, 79);
            this.mainLayer.addChild(btnDung);

            var txtDung = new cc.Sprite("#SlotThreeKingdom_text_dung.png");
            txtDung.setPosition(btnDung.getPosition());
            this.mainLayer.addChild(txtDung);

            var totalWinLabel = new cc.LabelBMFont("0", cc.SlotThreeKingdomRes.font.Bay_Buom_Stroke_White);
        ...
        showWinGame: function (amount,expected) {
            ...
            this.expectLabel.setString(cc.GlobalSlotThreeKingdom.FormatGold(expected));
            this._pending = false;
        ...
        setTotalWin: function (value) {
            this.totalWinLabel.setString(cc.GlobalSlotThreeKingdom.FormatGold(value));
        },
