...
(function () {
    SlotThreeKingdom.Popup = cc.Node.extend({
        ctor: function (width, height) {
            this._super();
            width = width || 1190;
            height = height || 673;
            // var border = new ccui.Scale9Sprite("SlotThreeKingdom_popup_border.png", cc.rect(30, 30, 2, 2));
            ...
            var closeBtn = new ccui.Button("SlotThreeKingdom_popup_close.png", "", "", ccui.Widget.PLIST_TEXTURE);
