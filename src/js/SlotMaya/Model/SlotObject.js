...
(function () {
    ...
    var SlotObject = cc.Sprite.extend({
        ctor: function (value, type) {
            ...
            if (isNaN(value))
                ...
                this._super("#slotmaya_" + AllSlotObject[value % 7] + ".png");
        ...
        setValue: function (v) {
            ...
            this._value = v;
            this.setSpriteFrame("slotmaya_" + AllSlotObject[this._value] + ".png");
    ...
    SlotMaya.AllSlotObject = AllSlotObject;
    SlotMaya.SlotObject = SlotObject;
})();
