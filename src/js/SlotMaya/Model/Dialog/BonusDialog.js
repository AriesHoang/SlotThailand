...
(function () {
    ...
    SlotMaya.BonusDialog = Dialog.extend({
        ...
        revealBonus: function () {
            ...
            var label = new cc.LabelBMFont(cc.GlobalSlotMaya.FormatGold(value), cc.SlotMayaRes.font.Arial_Bold_Blue_Bonus);
            ...
            for (var i = 0; i < this.allBonus.length; i++) {
                ...
                var subLabel = new cc.LabelBMFont(cc.GlobalSlotMaya.FormatGold(this._bonusArray[resultIndex]),
                    cc.SlotMayaRes.font.Arial_Bold_Purple_Bonus);
