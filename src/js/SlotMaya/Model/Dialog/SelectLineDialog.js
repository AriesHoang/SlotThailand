...
(function () {
    ...
    var SelectLineObject = SlotMaya.SelectLineObject;

    SlotMaya.SelectLineDialog = Dialog.extend({
        ctor: function (selectedLines, target, width, height) {
            width = width || 1315;
            height = height || 703;
            this._super.call(this, width, height);
            // this.setTitle("");
            var bg_selectedLine = new cc.Sprite("res/SlotMaya/SlotMaya_dialog_bg.png");
            bg_selectedLine.setPosition(this.width / 2 - 20, this.height / 2 - 70);
