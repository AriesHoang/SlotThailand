...
(function () {
    var HistoryDialog = SlotMaya.HistoryDialog || cc.Class;
    var RankingController = SlotMaya.RankingController;

    SlotMaya.RankingDialog = HistoryDialog.extend({
        ctor: function () {
        ...
        initHeader: function () {
            var scale = 1;
            // var time = new cc.LabelBMFont("THỜI GIAN", cc.SlotMayaRes.font.Gentona_White);
            ...
            // var phong = new cc.LabelBMFont("PHÒNG", cc.SlotMayaRes.font.Gentona_White);
            ...
            // var account = new cc.LabelBMFont("TÀI KHOẢN", cc.SlotMayaRes.font.Gentona_White);
            ...
            // var jackpot = new cc.LabelBMFont("SỐ HŨ", cc.SlotMayaRes.font.Gentona_White);
            ...
            // var sodongan = new cc.LabelBMFont("THẮNG", cc.SlotMayaRes.font.Gentona_White);
        ...
        showResult: function (result) {
            ...
            for (var i = 0; i < result.length; i++) {
                ...
                // var room = new cc.LabelBMFont(cc.GlobalSlotMaya.FormatGold(entry["betLevel"]) + "", cc.SlotMayaRes.font.Gentona_White, 160, cc.TEXT_ALIGNMENT_CENTER);
                var room = new cc.LabelTTF(cc.GlobalSlotMaya.FormatGold(entry["betLevel"]) + "", "Arial", 26, cc.size(160, 60), cc.TEXT_ALIGNMENT_CENTER);
                room.setPosition(340, container.height / 2);
                // room.setScale(scale);
                container.addChild(room);

                // var account = new cc.LabelBMFont(entry["username"] + "", cc.SlotMayaRes.font.Gentona_White);
                var account = new cc.LabelTTF(entry["username"] + "", "Arial", 26);
                account.setPosition(580, container.height / 2);
                // account.setScale(scale);
                container.addChild(account);

                // var jackpot = new cc.LabelBMFont(entry["totalJackpot"] + "", cc.SlotMayaRes.font.Gentona_White);
                ...
                // var reward = new cc.LabelBMFont(cc.GlobalSlotMaya.FormatGold(entry["totalReward"]) + "", cc.SlotMayaRes.font.Gentona_White);
                var reward = new cc.LabelTTF(cc.GlobalSlotMaya.FormatGold(entry["totalReward"]) + "", "Arial", 26);
