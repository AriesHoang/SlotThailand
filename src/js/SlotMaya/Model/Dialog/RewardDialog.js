...
(function () {
    ...
    SlotMaya.RewardDialog = Dialog.extend({
        ...
        initBackground: function () {
            var bg_reward = new cc.Sprite("res/SlotMaya/slotmaya_dialog_bg.png");
            bg_reward.setPosition(this.width / 2 - 20, this.height / 2 - 70);
            bg_reward.setScale(0.9);
        ...
        loadReward: function () {
            var reward = new cc.Sprite("res/SlotMaya/slotmaya_reward_paytable.png");
