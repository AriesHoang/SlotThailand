...
(function () {
    ...
    SlotMaya.HistoryDialog = Dialog.extend({
        ctor: function () {
            this._super.call(this, 1280, 691);

            var bg_history = new cc.Sprite("res/SlotMaya/slotmaya_dialog_bg.png");
            bg_history.setPosition(this.width / 2 - 20, this.height / 2 - 70);
        ...
        initHeader: function () {
            var scale = 1;
            // var phien = new cc.LabelBMFont("PHIÊN", cc.SlotMayaRes.font.Gentona_White);
            ...
            // var thoigian = new cc.LabelBMFont("THỜI GIAN", cc.SlotMayaRes.font.Gentona_White);
            ...
            // var betLine = new cc.LabelBMFont("SỐ DÒNG ĐẶT", cc.SlotMayaRes.font.Gentona_White);
            ...
            // var betLevel = new cc.LabelBMFont("MỨC CƯỢC", cc.SlotMayaRes.font.Gentona_White);
            ...
            // var rewardLine = new cc.LabelBMFont("SỐ DÒNG ĂN", cc.SlotMayaRes.font.Gentona_White);
            ...
            // var reward = new cc.LabelBMFont("NHẬN", cc.SlotMayaRes.font.Gentona_White);
        ...
        initDetailHeader: function () {
            // var betLineDetail = new cc.LabelBMFont("DÒNG ĐẶT", cc.SlotMayaRes.font.Gentona_White);
            ...
            // var rewardDetail = new cc.LabelBMFont("THẮNG", cc.SlotMayaRes.font.Gentona_White);
        ...
        showResult: function (result) {
            ...
            for (var i = 0; i < result.length; i++) {
                ...
                // var session = new cc.LabelBMFont("#" + entry["session"] + "", cc.SlotMayaRes.font.Gentona_White);
                ...
                // var time = new cc.LabelBMFont(entry["time"] + "", cc.SlotMayaRes.font.Gentona_White, 160, cc.TEXT_ALIGNMENT_CENTER);
                ...
                // var betCount = new cc.LabelBMFont(entry["betCount"] + "", cc.SlotMayaRes.font.Gentona_White);
                ...
                // var betLevel = new cc.LabelBMFont(cc.GlobalSlotMaya.FormatGold(entry["betLevel"]) + "", cc.SlotMayaRes.font.Gentona_White);
                var betLevel = new cc.LabelTTF(cc.GlobalSlotMaya.FormatGold(entry["betLevel"]) + "", "Arial", 26);
                betLevel.setPosition(700, container.height / 2);
                betLevel.setScale(scale);
                container.addChild(betLevel);

                // var rewardLine = new cc.LabelBMFont(entry["rewardLine"] + "", cc.SlotMayaRes.font.Gentona_White);
                ...
                // var reward = new cc.LabelBMFont(cc.GlobalSlotMaya.FormatGold(entry["reward"]) + "", cc.SlotMayaRes.font.Gentona_White);
                var reward = new cc.LabelTTF(cc.GlobalSlotMaya.FormatGold(entry["reward"]) + "", "Arial", 26);
        ...
        showDetail: function (details) {
            ...
            for (var i = 0; i < details.length; i++) {
                ...
                // var betLine = new cc.LabelBMFont(entry["line"] + "", cc.SlotMayaRes.font.Gentona_White);
