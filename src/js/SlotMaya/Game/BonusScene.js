...
(function () {
    ...
    var BonusController = SlotMaya.BonusController;
    var BonusPrepareDialog = SlotMaya.BonusPrepareDialog;
    var Dialog = SlotMaya.Dialog;
    var BonusDialog = SlotMaya.BonusDialog;
    var CompleteBonusDialog = SlotMaya.CompleteBonusDialog;

    SlotMaya.BonusScene = BaseScene.extend({
        ctor: function (betLevel, isSandbox) {
            ...
            var bg = new cc.Sprite("res/SlotMaya/slotmaya_bonus_bg.png");
        ...
        initTouches: function () {
            ...
            while (this._touches.length) {
                var randomIndex = cc.GlobalSlotMaya.randomInt(0, this._touches.length - 1);
                // var effect = sp.SkeletonAnimation.createWithJsonFile("res/SlotMaya/spine/touch_bonus_lion.json", "res/SlotMaya/spine/touch_bonus_lion.atlas");
                ...
                // effect.setSkin(allSkin[cc.GlobalSlotMaya.randomInt(0, allSkin.length - 1)]);
        ...
        initGUI: function () {
            ...
            var countDownLabel = new cc.LabelBMFont(" " + this.cooldown, cc.SlotMayaRes.font.Roboto_Bold_Bonus_30);
        ...
        initCharacter: function () {
            ...
            // var bonus_lion = new sp.SkeletonAnimation("res/SlotMaya/spine/bonus_lion.json", "res/SlotMaya/spine/bonus_lion.atlas");
            ...
            var bgReward = new cc.Sprite("res/SlotMaya/slotmaya_bg_board_reward.png");
        ...
        pushFlyingText: function (str, from, to, callback) {
            var flyingLabel = new cc.LabelBMFont(str, cc.SlotMayaRes.font.Bonus_Font);
        ...
        setBonusAmount: function (value) {
            ...
            this.totalBonusLabel.setString(cc.GlobalSlotMaya.FormatGold(this._bonusAmount));
        },
        ...
        showCompleteDialog: function () {
            ...
            function _exitCompleteBonusDialog() {
                ...
                cc.GlobalSlotMaya.totalRewardValue += value;

                // free spin game
                if (cc.GlobalSlotMaya.FreeSpinGame.enabled)
                    cc.GlobalSlotMaya.FreeSpinGame.reward += value;

                // cc.log(cc.GlobalSlotMaya.totalRewardValue);
                cc.director.replaceScene(new SlotMaya.SlotScene());
                if (thiz.cooldown >= 0) {
                    thiz._controller.sendEndgameRequest(cc.GlobalSlotMaya.isSandboxMode);
                }
            }
