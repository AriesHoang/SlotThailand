var SlotMayaFloatButton = (function () {
    var instance = null;

    var SlotMayaExpandedFloatBtn = cc.Node.extend({
        ctor: function () {
            this._super();
        ...
        initMinigameList: function () {
            var listMinigame = cc.GlobalSlotMaya.miniGameData;
        ...
        onExit: function () {
            SlotMayaFloatButton.getInstance().collapse();
            this._super();
        }
    });

    var SlotMayaFloatButtonClass = cc.Node.extend({
        ctor: function () {
            if (instance) {
        ...
        expand: function () {
            this.expanded = true;
            this.visible = false;
            var expandedNode = new SlotMayaExpandedFloatBtn();
    ...
    SlotMayaFloatButtonClass.getInstance = function () {
        if (!instance) {
            instance = new SlotMayaFloatButtonClass();
            instance.retain();
        }
        return instance;
    };

    return SlotMayaFloatButtonClass;
