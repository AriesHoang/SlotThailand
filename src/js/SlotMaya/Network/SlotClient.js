...
(function () {
    SlotMaya.SlotClient = (function () {
        ...
        var Clazz = cc.Class.extend({
            ...
            checkAndReconnect: function () {
                ...
                do {
                    ...
                    this._connectTimeout = setTimeout(function () {
                        ...
                        if (scene) {
                            var l = new SlotMaya.LoadingLayer("DISCONNECTED", "Please check your network connection");
            ...
            getToken: function () {
                if (cc.GlobalSlotMaya.AccessToken)
                    return cc.GlobalSlotMaya.AccessToken;
            ...
            sendExtensionRequestCurrentRoom: function (command, params) {
                if (SlotMaya.SFS.roomId < 0)
                    return;
                this.sendExtensionRequest(SlotMaya.SFS.roomId, command, params);
            }
        });
