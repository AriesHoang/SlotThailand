var SlotZodiacFloatButton = (function () {
    var instance = null;

    var SlotZodiacExpandedFloatBtn = cc.Node.extend({
        ctor: function () {
            this._super();
        ...
        initMinigameList: function () {
            var listMinigame = cc.GlobalSlotZodiac.miniGameData;
        ...
        createMiniGameButton: function (item, pos) {
            ...
            button.setColor(item.isReady ? cc.color(255, 255, 255) : cc.color(100, 100, 100));
        ...
        onExit: function () {
            SlotZodiacFloatButton.getInstance().collapse();
            this._super();
        }
    });

    var SlotZodiacFloatButtonClass = cc.Node.extend({
        ctor: function () {
            if (instance) {
            ...
            var bg = new cc.Sprite("#slotmaya_minigame_btn.png");
            this.addChild(bg);
            this.bg = bg;
        ...
        show: function (parent) {
            ...
            this.bg.setSpriteFrame("slotmaya_minigame_btn.png");
            this.moveToBorder();
        },
        ...
        expand: function () {
            this.expanded = true;
            this.visible = false;
            var expandedNode = new SlotZodiacExpandedFloatBtn();
    ...
    SlotZodiacFloatButtonClass.getInstance = function () {
        if (!instance) {
            instance = new SlotZodiacFloatButtonClass();
            instance.retain();
        }
        return instance;
    };

    return SlotZodiacFloatButtonClass;
