...
(function () {
    SlotZodiac.FreeSpinNode = cc.Node.extend({
        ctor: function () {
            this._super();
            ...
            var label = new cc.LabelBMFont("REMAINED FREESPIN ", cc.SlotZodiacRes.font.UVN_ThangVu);
            label.setPosition(-24, 15);
            this.addChild(label);

            var countLabel = new cc.LabelBMFont("000", cc.SlotZodiacRes.font.UVN_ThangVu);
