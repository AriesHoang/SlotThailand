...
(function () {
    SlotZodiac.LobbyNode = cc.Node.extend({
        ctor: function () {
            this._super();
            var bg = new cc.Sprite("res/SlotZodiac/main_background.png");
        ...
        initGUI: function () {
            ...
            var creditLabel = new cc.LabelBMFont("0", cc.SlotZodiacRes.font.Arial_White);
        ...
        initRoomNames: function () {
            ...
            for (var i = 0; i < poses.length; i++) {
                var label = new cc.LabelBMFont("ROOM NAME", cc.SlotZodiacRes.font.Roboto_Bold_White);
        ...
        initBetLevel: function () {
            ...
            for (var i = 0; i < xpos.length; i++) {
                ...
                var xuLabel = new cc.LabelBMFont(cc.GlobalSlotZodiac.FormatGold(Math.pow(10, i + 2)), cc.SlotZodiacRes.font.Roboto_Bold_White);
                ...
                var jackpotLabel = new cc.LabelBMFont("0", cc.SlotZodiacRes.font.Roboto_Bold_White);
        ...
        setJackpot: function (betId, value) {
            ...
            SlotZodiac.runActionNumber(this._allJackpotLabel[betId], value, this._oldJackpotValue[betId]);
