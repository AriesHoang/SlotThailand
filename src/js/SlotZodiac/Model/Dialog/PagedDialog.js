...
(function () {
    ...
    SlotZodiac.PagedDialog = Dialog.extend({
        ...
        _initWithSize: function (size, y) {
            ...
            pageContainerLayout.setPosition(this.width / 2, this.height / 2);
        ...
        initButton: function () {
            ...
            var prevBtn = new ccui.Button("slotkhaihoi_arrow_up.png", "slotkhaihoi_arrow_down.png", "", ccui.Widget.PLIST_TEXTURE);
            prevBtn.setPosition(-50, this.height / 2);
            prevBtn.setFlippedX(true);
            this.addChild(prevBtn, 1);

            var nextBtn = new ccui.Button("slotkhaihoi_arrow_up.png", "slotkhaihoi_arrow_down.png", "", ccui.Widget.PLIST_TEXTURE);
            nextBtn.setPosition(this.width + 50, this.height / 2);
        ...
        addPage: function (page) {
            ...
            page.setPosition(this.pageContainerLayout.width / 2, this.pageContainerLayout.height / 2 - 60);
            page.visible = false;
            if (!this.currentPage) {
                this.selectPage(0);
            }
