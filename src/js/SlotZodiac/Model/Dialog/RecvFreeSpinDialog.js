...
(function () {
    ...
    SlotZodiac.RecvFreeSpinDialog = Dialog.extend({
        ctor: function (amount, cap1, cap2, width, height) {
            amount = isNaN(amount) ? 1 : amount;
            amount += "";
            this._super.call(this, width, height);

            var label1 = new cc.LabelBMFont(cap1 ? cap1 : "YOU'VE RECEIVED", cc.SlotZodiacRes.font.Roboto_Bold_White);
            label1.setPosition(837, 570);
            label1.setScale(1.5);
            this.addChild(label1);

            var label2 = new cc.LabelBMFont(cap2 ? cap2 : "FREE SPIN", cc.SlotZodiacRes.font.Roboto_Bold_White);
            ...
            var freeAmountLabel = new cc.LabelBMFont(amount, cc.SlotZodiacRes.font.Roboto_Bold_White);
