...
(function () {
    var SlotObject = SlotZodiac.SlotObject;
    var AllSlotObject = SlotZodiac.AllSlotObject;

    SlotZodiac.SlotFrame = cc.Node.extend({
        ...
        _initSlotFrame: function () {
            ...
            var slotBackground = new cc.Sprite("res/SlotZodiac/slotmaya_frame.png");
            slotBackground.setPositionY(80);
            // var slotFrame = new cc.Sprite("res/SlotZodiac/slotmaya_bg_symbol.png");
            ...
            for (var i = 0; i < row * column; i++) {
                var slotObj = new SlotObject(cc.GlobalSlotZodiac.randomInt(0, 7));
            ...
            for (var i = 0; i < (row + 2) * column; i++) {
                var rollingSlotObj = new cc.Sprite("#slotzodiac_" + AllSlotObject[cc.GlobalSlotZodiac.randomInt(0, 6)] + ".png");
