...
(function () {
    var SlotFrame = SlotZodiac.SlotFrame || cc.Class;
    var WireEffect = [];
    ...
    SlotZodiac.WiredSlotFrame = SlotFrame.extend({
        ctor: function (row, column) {
            this._super.apply(this, arguments);

            this.effectSrc = [
                "res/SlotZodiac/spine/spine_eff_symbol"
            ];
        },
        ...
        _showAllLine: function (wireIndex) {
            var wireNode = new cc.Sprite("res/SlotZodiac/payline/payline_" + wireIndex + ".png");
