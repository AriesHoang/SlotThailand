...
(function () {
    SlotZodiac.LoadingLayer = cc.Node.extend({
        ...
        initLabels: function (title, content) {
            var titleLabel = new cc.LabelBMFont(title, cc.SlotZodiacRes.font.Gentona_White_30);
            // titleLabel.setScale(0.7);
            titleLabel.setPosition(0, 115);
            this.addChild(titleLabel);

            var contentLabel = new cc.LabelBMFont(content, cc.SlotZodiacRes.font.Gentona_White_30);
