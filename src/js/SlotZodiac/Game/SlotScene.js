...
(function () {
    ...
    var SettingItem = SlotZodiac.SettingItem;
    var FreeSpinNode = SlotZodiac.FreeSpinNode;
    var HistoryDialog = SlotZodiac.HistoryDialog;
    var RankingDialog = SlotZodiac.RankingDialog;
    var CompleteFreeSpinDialog = SlotZodiac.CompleteFreeSpinDialog;
    var SelectLineDialog = SlotZodiac.SelectLineDialog;
    ...
    var SlotScene = BaseScene.extend({
        ctor: function (row, column) {
            ...
            var slotFrame = new SlotZodiac.WiredSlotFrame(row, column);
            SlotZodiac.Lines && slotFrame.setWires(SlotZodiac.Lines);
            this.slotFrame = slotFrame;
            slotFrame.setPosition(cc.winSize.width / 2, cc.winSize.height / 2 + 35);
            this.gameLayer.addChild(slotFrame);
            if (cc.GlobalSlotZodiac.lastResult)
                slotFrame.setResult(cc.GlobalSlotZodiac.lastResult);
            ...
            var btmBar = new cc.Sprite("res/SlotZodiac/slotzodiac_bg_bottom.png");
            ...
            this.setSelectedLines(cc.GlobalSlotZodiac.SlotState.lines || defaultLines);
            this.setFreeSpinCount(0);
            thiz.setBetLevel(cc.GlobalSlotZodiac.SlotState.betLevel || 0,
                isNaN(cc.GlobalSlotZodiac.SlotState.betLevel) || cc.GlobalSlotZodiac.isSandboxMode);
            this.setTotalWin(cc.GlobalSlotZodiac.totalRewardValue || 0, true, null, true, true);
            this.setCredit(cc.GlobalSlotZodiac.PlayerGold);

            // this.initCheatLayer();

            this._performPendingFSAction();
            this.setSession(cc.GlobalSlotZodiac.sessionId);
            if (cc.GlobalSlotZodiac.FreeSpinCount)
                this.setFreeSpinCount(cc.GlobalSlotZodiac.FreeSpinCount);
            if (cc.GlobalSlotZodiac.PortalFreeSpinCount)
                this.setPortalFreeSpinCount(cc.GlobalSlotZodiac.PortalFreeSpinCount);
            else if (cc.GlobalSlotZodiac.FreeSpinGame.enabled && cc.GlobalSlotZodiac.FreeSpinCount === 0)
                this.showCompleteFreeSpinDialog();

            if (cc.GlobalSlotZodiac.AutoSpin)
                this.toggleAutoSpin();

            if (cc.GlobalSlotZodiac.isSandboxMode) {
                this.switchToSandbox(cc.GlobalSlotZodiac.PlayerSandboxGold);
                //this._setJackPotLabel(cc.GlobalSlotZodiac.sandboxJackpot);
            }
            //Update tiền khi chơi minigame
            GlobalEvent.getInstance().addListener("onUpdateUserChangeMoney", this.updateUserChangeMoney, this);

            SlotZodiacFloatButton.getInstance().show(this);
            //Hide all minigame
            MiniGameNavigator.hideAll();
            // SlotZodiacMiniGameNavigator.hideAll();

            SlotZodiacSoundPlayer.playSound("theme_khaihoi", true);
        ...
        testShowLine: function () {
            // for (var i = 1; i < 2; i++) {
            // var wireNode = new cc.Sprite("res/SlotZodiac/payline/payline_19.png");
        ...
        initBackground: function () {
            //background
            var background = new cc.Sprite("res/SlotZodiac/main_background.png");
            cc.GlobalSlotZodiac.scaleBackground(background);
        ...
        initGUI: function () {
            ...
            var jackpotLabel = new cc.LabelBMFont("0", cc.SlotZodiacRes.font.Jackpot_Font);
            // jackpotLabel.setScale(0.7);
            jackpotLabel.setPosition(cc.winSize.width / 2 - 20, cc.winSize.height - 120);
            ...
            var creditLabel = new cc.LabelTTF("0", "Arial", 35);
            ...
            var freeSpinCountLabel = new cc.LabelBMFont("0", cc.SlotZodiacRes.font.UVN_ThangVu);
            ...
            var sessionLabel = new cc.LabelTTF("#00000000000", "Arial", 35);
            sessionLabel.setPosition(sessionBg.x, sessionBg.y + 10);
            sessionLabel.setFontFillColor(cc.color("#000000"));
            ...
            selectLineBtn.addClickEventListener(function () {
                if (!thiz.musicSetting.getDisabled())
                    SlotZodiacSoundPlayer.playSound("button_click", false);
                if (!thiz.autoSpin) {
            ...
            sandboxSprite.setPosition(1022, 930);
            ...
            var goldenTimeXLabel = new cc.LabelBMFont("X1", cc.SlotZodiacRes.font.UVN_DUNGDAN_GOLDENTIME);
            ...
            var goldenTimeLabel = new cc.LabelBMFont("00:00:00", cc.SlotZodiacRes.font.SVN_GENICA_GOLDENTIME);
            ...
            var portalFSCount = new cc.LabelBMFont("0", cc.SlotZodiacRes.font.Gentona_Number);
        ...
        initController: function () {
            this._controller = new SlotZodiac.SlotController(this);
        },
        ...
        initButton: function () {
            ...
            sandboxBtn.setPosition(420, cc.winSize.height - 160);
            ...
            // // var rollSpine = sp.SkeletonAnimation.createWithJsonFile("res/SlotZodiac/spine/spine.json", "res/SlotZodiac/spine/spine.atlas");
            // var rollSpine = new sp.SkeletonAnimation("res/SlotZodiac/spine/spine.json", "res/SlotZodiac/spine/spine.atlas");
            ...
            homeBtn.addClickEventListener(function () {
                ...
                if (!thiz.musicSetting.getDisabled())
                    SlotZodiacSoundPlayer.playSound("button_click", false);
                SlotZodiac.SlotClient.getInstance().closeSocket();
                MiniGameNavigator.hideAll();
                SlotZodiacSoundPlayer.stopSound("theme_khaihoi");
                SlotZodiacSoundPlayer.stopSound("spin");
                thiz.autoSpin = false;
        ...
        initCharacter: function () {
            var tree = new cc.Sprite("res/SlotZodiac/slotzodiac_tree.png");
            tree.setPosition(185, cc.winSize.height / 2 - 50);
            this.gameLayer.addChild(tree);
        ...
        toggleAutoSpin: function () {
            ...
            cc.GlobalSlotZodiac.AutoSpin = this.autoSpin;
        },
        ...
        setCredit: function (value, isSandbox) {
            ...
            this._pendingCredit = function () {
                ...
                SlotZodiac.runActionNumber(this.creditLabel, value, 1);

                if (thiz.isSandboxMode) {
                    cc.GlobalSlotZodiac.PlayerSandboxGold = value;
                }
        ...
        setCreditAfterRoll: function (value, isSandbox) {
            ...
            if (isNaN(value) || (this.isSandboxMode !== isSandbox))
                return;
            cc.GlobalSlotZodiac.PlayerGold = value;
            this.creditLabel.stopAllActions();
            SlotZodiac.runActionNumber(this.creditLabel, cc.GlobalSlotZodiac.PlayerGold, 1);
        },
        ...
        setSelectedLines: function (selectedLines) {
            if (selectedLines instanceof Array && selectedLines.length > 0) {
                ...
                this.totalBetLabel.setString(cc.GlobalSlotZodiac.FormatGold(
                    this.allBetLevel[this.betLevel] * this.selectedLines.length));

                cc.GlobalSlotZodiac.SlotState.lines = this.selectedLines;
            }
        },
        ...
        onQuayBtnClick: function (cheatType) {
            ...
            if (!this.musicSetting.getDisabled())
                SlotZodiacSoundPlayer.playSound("spin", false);

            if (this.portalFreeSpinCount) {
                this.setPortalFreeSpinCount(this.portalFreeSpinCount - 1);
                this.portalFreeSpin.visible = true;
                cc.GlobalSlotZodiac.FreeSpinGame.enabled = true;
                cc.GlobalSlotZodiac.FreeSpinGame.count++;
        ...
        rewardCallback: function (totalResult, result) {
            ...
            var effect_win = sp.SkeletonAnimation.createWithJsonFile('res/SlotZodiac/spine/liondance_win.json', 'res/SlotZodiac/spine/liondance_win.atlas');
            ...
            var showBonusAction = new cc.CallFunc(function () {
                ...
                // if (!thiz.musicSetting.getDisabled())
                //     SlotZodiacSoundPlayer.playSound("bonus", false);
                thiz.hideAllDialog();
            ...
            var showFreeSpinAction = new cc.CallFunc(function () {
                if (!thiz.musicSetting.getDisabled())
                    SlotZodiacSoundPlayer.playSound("win_freespin", false);
                ...
                var label = new cc.LabelBMFont(totalResult["free_spin"] + " TURN", cc.SlotZodiacRes.font.UVN_ThangVu);
                label.setScale(2);
            ...
            var afterAction = new cc.CallFunc(function () {
                var chainSequence = function () {
                    ...
                    if (totalResult["free_spin"] && totalResult["bonus"]) {
                        ...
                        showFreeSpinAction.release();
                        cc.GlobalSlotZodiac.pendingFSReward = totalResult["free_spin"];
        ...
        onRollResult: function (result) {
            ...
            cc.GlobalSlotZodiac.lastResult = result["1"];
            for (var i = 0; i < this.slotFrame.column; i++) {
                setTimeout(function (index) {
            ...
            setTimeout(function () {
                thiz.setState(SlotState.SHOWING_REWARD);
                var effect_win = new sp.SkeletonAnimation('res/SlotZodiac/spine/liondance_win.json', 'res/SlotZodiac/spine/liondance_win.atlas');
                ...
                var chainSequence = function () {
                    ...
                    slotFrame.showReward(false, result["2"], function (shownLine) {
                        if (shownLine.type === 2) {
                            // if (!thiz.musicSetting.getDisabled())
                            //     SlotZodiacSoundPlayer.playSound("smallWin", false);
                    ...
                    if (!result["free_spin"]
                        ...
                        && (cc.GlobalSlotZodiac.FreeSpinGame.count === 0 || cc.GlobalSlotZodiac.FreeSpinGame.count === undefined)) {
                        // cc.log("------ free_spin ------: " + result["free_spin"]
                        //     + "\n ------ bonus ------: " + result["bonus"]
                        //     + "\n ------ portalFreeSpinCount ------: " + thiz.portalFreeSpinCount
                        //     + "\n ------ freeSpinCount ------: " + thiz.freeSpinCount
                        //     + "\n ------ Global freeSpinCount------: " + cc.GlobalSlotZodiac.FreeSpinGame.count);
                        thiz.setState(SlotState.IDLE);
                    }
                };
                ...
                var showBigWinAction = new cc.CallFunc(function () {
                    ...
                    if ([2, 3, 4, 5].indexOf(winType) !== -1) {
                        var label = new cc.LabelBMFont("", cc.SlotZodiacRes.font.Total_Reward_Font);
                        ...
                        // SlotZodiac.runActionNumber(label, rewardValue, 1);

                        // label.setString(cc.GlobalSlotZodiac.FormatGold(rewardValue));
                    ...
                    switch (winType) {
                        case 2:
                            // cc.log("case2");
                            // if (!thiz.musicSetting.getDisabled())
                            //     SlotZodiacSoundPlayer.playSound("mediumWin", false);
                            effect_win_layer.visible = true;
                        ...
                        case 4:
                            // cc.log("case34");
                            // if (!thiz.musicSetting.getDisabled())
                            //     SlotZodiacSoundPlayer.playSound("largeWin", false);
                            effect_win_layer.visible = true;
                        ...
                        case 5:
                            // cc.log("case5");
                            // if (!thiz.musicSetting.getDisabled())
                            //     SlotZodiacSoundPlayer.playSound("jackpot", false);
                            effect_win_layer.visible = true;
                            effect_win.setSkin("nohu");
                            effect_win.setAnimation(0, "animation", false);
                            thiz.totalRewardLabel.setString(cc.GlobalSlotZodiac.FormatGold(result["jc"]));
                            effect_win.setCompleteListener(function () {
                                chainSequence();
                            });
                            break;
        ...
        setBetLevel: function (betId, noRequest) {
            if (~[0, 1, 2].indexOf(betId)) {
                this.betLevel = betId;
                this.betLevelLabel.setString(cc.GlobalSlotZodiac.FormatGold(this.allBetLevel[betId]));
                this.totalBetLabel.setString(cc.GlobalSlotZodiac.FormatGold(this.allBetLevel[betId] * this.selectedLines.length));
                this._setJackPotLabel(this.jackpotValues[this.betLevel]);

                if (!noRequest)
                    this._controller.sendSetBetLevelRequest(betId);

                cc.GlobalSlotZodiac.SlotState.betLevel = this.betLevel;
        ...
        updateBetAmount: function (allBetLevel) {
            ...
            this.betLevelLabel.setString(cc.GlobalSlotZodiac.FormatGold(this.allBetLevel[this.betLevel]));
            this.totalBetLabel.setString(cc.GlobalSlotZodiac.FormatGold(this.allBetLevel[this.betLevel] * this.selectedLines.length));
        },
        ...
        _setJackPotLabel: function (value) {
            ...
            SlotZodiac.runActionNumber(this.jackpotLabel, value);

            if (this.isSandboxMode)
                cc.GlobalSlotZodiac.sandboxJackpot = value;
        },
        ...
        setPendingPortalFreeSpinCount: function (count) {
            var thiz = this;
            cc.GlobalSlotZodiac.PortalFreeSpinCount = count;
        ...
        setPendingFreeSpinCount: function (count) {
            var thiz = this;
            cc.GlobalSlotZodiac.FreeSpinCount = count;
        ...
        configLine: function (lines) {
            SlotZodiac.Lines && this.slotFrame.setWires(lines);
        },
        ...
        setTotalWin: function (value, hideEffect, jackpotValue, isRaw, skipFSReward) {
            ...
            cc.GlobalSlotZodiac.totalRewardValue = value + jackpotValue;
            if (value === 0) {
                this.totalRewardLabel.setString(cc.GlobalSlotZodiac.FormatGold(value));
            } else if (value > 0) {
                // free spin game
                if (!skipFSReward && cc.GlobalSlotZodiac.FreeSpinGame.enabled)
                    cc.GlobalSlotZodiac.FreeSpinGame.reward += value;

                if (hideEffect) {
                    this.totalRewardLabel.setString(cc.GlobalSlotZodiac.FormatGold(value + jackpotValue));
                } else {
                    ...
                    var totalLabel = new cc.LabelBMFont(cc.GlobalSlotZodiac.FormatGold(value + jackpotValue), cc.SlotZodiacRes.font.Total_Reward_Font);
                    ...
                    var callFunc = new cc.CallFunc(function () {
                        ...
                        thiz.totalRewardLabel.setString(cc.GlobalSlotZodiac.FormatGold(value + jackpotValue));
                    });
        ...
        switchToSandbox: function (coin) {
            ...
            cc.GlobalSlotZodiac.isSandboxMode = true;
        ...
        quitSandbox: function () {
            ...
            this.sandboxSprite.visible = false;
            cc.GlobalSlotZodiac.isSandboxMode = false;
            cc.GlobalSlotZodiac.sandboxJackpot = undefined;
        },
        ...
        setSession: function (sessionId) {
            ...
            cc.GlobalSlotZodiac.sessionId = sessionId;
        },
        ...
        showCompleteFreeSpinDialog: function () {
            ...
            var d = new CompleteFreeSpinDialog(cc.GlobalSlotZodiac.FreeSpinGame.count, cc.GlobalSlotZodiac.FreeSpinGame.reward);
            var thiz = this;
            ...
            // reset freespin game
            cc.GlobalSlotZodiac.FreeSpinGame = {
                enabled: false,
                count: 0,
                reward: 0
            };
        ...
        showBonusGame: function () {
            ...
            cc.director.replaceScene(new SlotZodiac.BonusScene(this.betLevel, this.isSandboxMode));
            SlotZodiacSoundPlayer.stopSound("theme_khaihoi");
            SlotZodiacSoundPlayer.stopSound("theme_khaihoi1");
        },

        _performPendingFSAction: function () {
            if (!cc.GlobalSlotZodiac.pendingFSReward)
                return;

            var thiz = this;
            var effect_freespin = sp.SkeletonAnimation.createWithJsonFile('res/SlotZodiac/spine/liondance_win.json', 'res/SlotZodiac/spine/liondance_win.atlas');
            ...
            var label = new cc.LabelBMFont("+" + cc.GlobalSlotZodiac.pendingFSReward + " TURN", cc.SlotZodiacRes.font.Room_Name);
            label.setScale(2);
            label.setPosition(cc.winSize.width / 2, cc.winSize.height / 2 - 210);
            ...
            cc.GlobalSlotZodiac.pendingFSReward = undefined;
        },
        ...
        onReconnect: function () {
            ...
            this.stopRolling();
            this.setBetLevel(cc.GlobalSlotZodiac.SlotState.betLevel || 0);
        },
        ...
        updateUserChangeMoney: function (eventName, money) {
            ...
            if (this.creditLabel) {
                this.creditLabel.stopAllActions();
                SlotZodiac.runActionNumber(this.creditLabel, money);
                cc.GlobalSlotZodiac.PlayerGold = money;
                // this.lobbyNode.setCredit(money);
            }
        }
    });

    SlotZodiac.SlotState = SlotState;
    SlotZodiac.SlotScene = SlotScene;
})();
